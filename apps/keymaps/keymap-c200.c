...
static const struct button_mapping button_context_keyboard[] = {
    ...
    { ACTION_KBD_PAGE_FLIP,    BUTTON_SELECT|BUTTON_LEFT,       BUTTON_SELECT },
    { ACTION_KBD_PAGE_FLIP,    BUTTON_SELECT|BUTTON_RIGHT,      BUTTON_SELECT },
...
const struct button_mapping* get_context_mapping(int context)
{
    switch (context)
    {
        ...
        case CONTEXT_SETTINGS_TIME:             { return button_context_settings; }
        ...
        case CONTEXT_TREE:
        case CONTEXT_MAINMENU:                  { return button_context_listtree_scroll_with_combo; }
