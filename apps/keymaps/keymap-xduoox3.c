...
static const struct button_mapping button_context_wps[] = {
    ...
    { ACTION_WPS_ABSETB_NEXTDIR,    BUTTON_ALT|BUTTON_NEXT,   BUTTON_POWER },
    { ACTION_WPS_ABSETA_PREVDIR,    BUTTON_ALT|BUTTON_PREV,   BUTTON_POWER },
    { ACTION_WPS_ABRESET,           BUTTON_ALT|BUTTON_PLAY,   BUTTON_POWER },
...
static const struct button_mapping button_context_listtree_scroll_with_combo[]  = {
    ...
    { ACTION_TREE_PGLEFT,    BUTTON_ALT|BUTTON_VOL_DOWN,               BUTTON_NONE },
    { ACTION_TREE_PGLEFT,    BUTTON_ALT|BUTTON_VOL_DOWN|BUTTON_REPEAT, BUTTON_NONE },
    { ACTION_TREE_PGRIGHT,   BUTTON_ALT|BUTTON_VOL_UP,                 BUTTON_NONE },
    { ACTION_TREE_PGRIGHT,   BUTTON_ALT|BUTTON_VOL_UP|BUTTON_REPEAT,   BUTTON_NONE },
