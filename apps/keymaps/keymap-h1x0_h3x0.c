...
static const struct button_mapping button_context_listtree_scroll_with_combo[] = {
    ...
    { ACTION_TREE_PGRIGHT,      BUTTON_ON|BUTTON_RIGHT,               BUTTON_NONE },
...
static const struct button_mapping button_context_listtree_scroll_w_cmb_h300lcdremote[] = {
    ...
    { ACTION_TREE_PGLEFT,    BUTTON_RC_MENU|BUTTON_RC_SOURCE,                BUTTON_NONE },
    { ACTION_TREE_PGLEFT,    BUTTON_RC_MENU|BUTTON_RC_SOURCE|BUTTON_REPEAT,  BUTTON_NONE },

    { ACTION_TREE_PGRIGHT,   BUTTON_RC_MENU|BUTTON_RC_BITRATE,               BUTTON_NONE },
...
static const struct button_mapping* get_context_mapping_remote(int context)
{
    ...
    switch (context)
    {
        case CONTEXT_STD:                 { return remote_btn_ctxt_std; }
        case CONTEXT_WPS:                 { return button_context_wps_remotescommon; } /* common for all remotes */
        case CONTEXT_CUSTOM|CONTEXT_WPS:  { return remote_btn_ctxt_wps; }
        case CONTEXT_CUSTOM|CONTEXT_TREE: { return remote_btn_ctxt_tree; }
        case CONTEXT_SETTINGS_TIME:
        case CONTEXT_SETTINGS_RECTRIGGER: { return remote_btn_ctxt_settingsgrph; }
        case CONTEXT_SETTINGS:            { return remote_btn_ctxt_settings; }
        case CONTEXT_YESNOSCREEN:         { return remote_btn_ctxt_yesno; }
        case CONTEXT_BOOKMARKSCREEN:      { return remote_btn_ctxt_bmark; }
        case CONTEXT_QUICKSCREEN:         { return remote_btn_ctxt_quickscreen; }
        case CONTEXT_PITCHSCREEN:         { return remote_btn_ctxt_pitchscreen; }
        case CONTEXT_RECSCREEN:           { return remote_btn_ctxt_recscreen; }
        case CONTEXT_KEYBOARD:
        case CONTEXT_MORSE_INPUT:         { return remote_btn_ctxt_keyboard; }
        case CONTEXT_FM:                  { return remote_btn_ctxt_radio; }

        case CONTEXT_LIST:                { return remote_btn_ctxt_list; }
        ...
        default:                          { return remote_btn_ctxt_std; }
    }
