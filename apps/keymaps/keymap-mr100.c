...
#ifdef USB_ENABLE_HID
        case CONTEXT_USB_HID:                   { return remote_button_context_usb_hid; }
        case CONTEXT_USB_HID_MODE_MULTIMEDIA:   { return remote_button_context_usb_hid_mode_multimedia; }
        case CONTEXT_USB_HID_MODE_PRESENTATION: { return remote_button_context_usb_hid_mode_presentation; }
        case CONTEXT_USB_HID_MODE_BROWSER:      { return remote_button_context_usb_hid_mode_browser; }
#ifdef HAVE_USB_HID_MOUSE
        case CONTEXT_USB_HID_MODE_MOUSE:        { return remote_button_context_usb_hid_mode_mouse; }
#endif
#endif
        case CONTEXT_MAINMENU:
        case CONTEXT_TREE:                      { return remote_button_context_tree; }
