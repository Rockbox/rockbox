...
#define BUTTON_SELECT BUTTON_RC_MODE
#define BUTTON_MENU BUTTON_RC_HEART
#define BUTTON_VOL_UP BUTTON_RC_VOL_UP
#define BUTTON_VOL_DOWN BUTTON_RC_VOL_DOWN
#define BUTTON_A BUTTON_NONE
#define BUTTON_RC_DSP BUTTON_RC_HEART
...
static const struct button_mapping button_context_wps[]  = {
    ...
    { ACTION_WPS_ABRESET,       BUTTON_A|BUTTON_SELECT,        BUTTON_A },
    ...
    { ACTION_WPS_PITCHSCREEN,   BUTTON_A|BUTTON_DOWN,          BUTTON_A },
