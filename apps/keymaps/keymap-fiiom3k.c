...
static const struct button_mapping button_context_settings_eq[] = {
    ...
    {ACTION_SETTINGS_INCBIGSTEP,    BUTTON_VOL_UP,                  BUTTON_NONE},
    {ACTION_SETTINGS_INCBIGSTEP,    BUTTON_VOL_UP|BUTTON_REPEAT,    BUTTON_NONE},
    {ACTION_SETTINGS_DEC,           BUTTON_LEFT,                    BUTTON_NONE},
    {ACTION_SETTINGS_DECREPEAT,     BUTTON_LEFT|BUTTON_REPEAT,      BUTTON_NONE},
    {ACTION_SETTINGS_DECBIGSTEP,    BUTTON_VOL_DOWN,                BUTTON_NONE},
    {ACTION_SETTINGS_DECBIGSTEP,    BUTTON_VOL_DOWN|BUTTON_REPEAT,  BUTTON_NONE},
    {ACTION_STD_NEXT,               BUTTON_DOWN,                    BUTTON_NONE},
    {ACTION_STD_PREV,               BUTTON_UP,                      BUTTON_NONE},
...
static const struct button_mapping button_context_keyboard[] = {
    ...
    {ACTION_KBD_ABORT,          BUTTON_POWER|BUTTON_REPEAT,     BUTTON_POWER},
