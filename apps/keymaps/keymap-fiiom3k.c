...
static const struct button_mapping button_context_wps[] = {
    ...
    {ACTION_WPS_SKIPNEXT|ACTION_WHEN_LOCKED, BUTTON_VOL_UP|BUTTON_REL,                  BUTTON_PLAY|BUTTON_VOL_UP},
    {ACTION_WPS_SEEKFWD|ACTION_WHEN_LOCKED,  BUTTON_PLAY|BUTTON_VOL_UP|BUTTON_REPEAT,   BUTTON_NONE},
    {ACTION_WPS_STOPSEEK|ACTION_WHEN_LOCKED, BUTTON_PLAY|BUTTON_VOL_UP|BUTTON_REL,      BUTTON_PLAY|BUTTON_VOL_UP|BUTTON_REPEAT},
    {ACTION_WPS_SKIPPREV|ACTION_WHEN_LOCKED, BUTTON_VOL_DOWN|BUTTON_REL,                BUTTON_PLAY|BUTTON_VOL_DOWN},
    {ACTION_WPS_SEEKBACK|ACTION_WHEN_LOCKED, BUTTON_PLAY|BUTTON_VOL_DOWN|BUTTON_REPEAT, BUTTON_NONE},
    {ACTION_WPS_STOPSEEK|ACTION_WHEN_LOCKED, BUTTON_PLAY|BUTTON_VOL_DOWN|BUTTON_REL,    BUTTON_PLAY|BUTTON_VOL_DOWN|BUTTON_REPEAT},
