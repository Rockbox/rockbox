...
/* Button Code Definitions for HiFi E.T. MA9 reference design target */
...
static const struct button_mapping button_context_wps[] = {
    ...
    { ACTION_WPS_QUICKSCREEN,   BUTTON_DOWN|BUTTON_REL,     BUTTON_DOWN },

#ifndef HAS_BUTTON_HOLD
    { ACTION_STD_KEYLOCK,  BUTTON_MENU|BUTTON_PLAY,        BUTTON_MENU },
#endif
