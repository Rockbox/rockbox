...
static const struct button_mapping button_context_listtree_scroll_with_combo[] = {
    ...
    { ACTION_TREE_PGLEFT,     BUTTON_REW|BUTTON_PLAY,               BUTTON_NONE },
    { ACTION_TREE_PGLEFT,     BUTTON_REW|BUTTON_PLAY|BUTTON_REPEAT, BUTTON_NONE },

    { ACTION_TREE_PGRIGHT,    BUTTON_FF|BUTTON_PLAY,                BUTTON_NONE },
...
static const struct button_mapping remote_button_context_listtree_scroll_with_combo[] = {
    ...
    { ACTION_TREE_PGLEFT,     BUTTON_RC_REW|BUTTON_RC_PLAY,               BUTTON_NONE },
    { ACTION_TREE_PGLEFT,     BUTTON_RC_REW|BUTTON_RC_PLAY|BUTTON_REPEAT, BUTTON_NONE },

    { ACTION_TREE_PGRIGHT,    BUTTON_RC_FF|BUTTON_RC_PLAY,                BUTTON_NONE },
...
static const struct button_mapping button_context_usb_hid_mode_multimedia[] = {
    ...
    { ACTION_USB_HID_MULTIMEDIA_VOLUME_DOWN,         BUTTON_SCROLL_DOWN,               BUTTON_NONE },
    { ACTION_USB_HID_MULTIMEDIA_VOLUME_DOWN,         BUTTON_SCROLL_DOWN|BUTTON_REPEAT, BUTTON_NONE },

    { ACTION_USB_HID_MULTIMEDIA_VOLUME_MUTE,         BUTTON_RIGHT|BUTTON_REL,          BUTTON_RIGHT },

    { ACTION_USB_HID_MULTIMEDIA_VOLUME_UP,           BUTTON_SCROLL_UP,                 BUTTON_NONE },
    { ACTION_USB_HID_MULTIMEDIA_VOLUME_UP,           BUTTON_SCROLL_UP|BUTTON_REPEAT,   BUTTON_NONE },
...
static const struct button_mapping* get_context_mapping_remote( int context )
{
    ...
    switch (context)
    {
        case CONTEXT_STD:                       { return remote_button_context_standard; }
        case CONTEXT_WPS:                       { return remote_button_context_wps; }
        case CONTEXT_LIST:                      { return remote_button_context_list; }
        case CONTEXT_CUSTOM|CONTEXT_TREE:       { return remote_button_context_tree; }
        case CONTEXT_QUICKSCREEN:               { return remote_button_context_quickscreen; }
        case CONTEXT_PITCHSCREEN:               { return remote_button_context_pitchscreen; }
        case CONTEXT_RECSCREEN:                 { return button_context_recscreen; }

        case CONTEXT_MAINMENU:                  { return remote_button_context_standard; }
        case CONTEXT_TREE:
...
const struct button_mapping* get_context_mapping(int context)
{
    ...
    switch (context)
    {
        ...
        case CONTEXT_USB_HID_MODE_MULTIMEDIA:   { return button_context_usb_hid_mode_multimedia; }
        case CONTEXT_USB_HID_MODE_PRESENTATION: { return button_context_usb_hid_mode_presentation; }
        case CONTEXT_USB_HID_MODE_BROWSER:      { return button_context_usb_hid_mode_browser; }
#ifdef HAVE_USB_HID_MOUSE
        case CONTEXT_USB_HID_MODE_MOUSE:        { return button_context_usb_hid_mode_mouse; }
#endif
#endif
        case CONTEXT_TREE:
