...
static const struct button_mapping button_context_wps[] = {
    ...
    { ACTION_WPS_ABSETB_NEXTDIR,   BUTTON_POWER|BUTTON_PREV,       BUTTON_POWER },
    { ACTION_WPS_ABSETA_PREVDIR,   BUTTON_POWER|BUTTON_NEXT,       BUTTON_POWER },
    ...
    { ACTION_WPS_PITCHSCREEN,      BUTTON_LEFT|BUTTON_REL,         BUTTON_LEFT  },
    { ACTION_WPS_ID3SCREEN,        BUTTON_LEFT|BUTTON_REPEAT,      BUTTON_LEFT  },
    { ACTION_WPS_LIST_BOOKMARKS,   BUTTON_SELECT|BUTTON_REL,       BUTTON_SELECT},
    { ACTION_WPS_CREATE_BOOKMARK,  BUTTON_SELECT|BUTTON_REPEAT,    BUTTON_SELECT},
    { ACTION_WPS_HOTKEY,           BUTTON_RIGHT|BUTTON_REL,        BUTTON_RIGHT },
    { ACTION_WPS_VIEW_PLAYLIST,    BUTTON_RIGHT|BUTTON_REPEAT,     BUTTON_RIGHT },
...
static const struct button_mapping button_context_keyboard[] = {
    ...
    { ACTION_KBD_BACKSPACE,    BUTTON_PLAY,                    BUTTON_NONE },
...
static const struct button_mapping button_context_pitchscreen[] = {
    ...
    { ACTION_PS_SLOWER,         BUTTON_PREV,                BUTTON_NONE },
    { ACTION_PS_FASTER,         BUTTON_NEXT,                BUTTON_NONE },
...
static const struct button_mapping button_context_tree[] = {
    ...
    { ACTION_TREE_HOTKEY, BUTTON_NEXT,                   BUTTON_NONE },
