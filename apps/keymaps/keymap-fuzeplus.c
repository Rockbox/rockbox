...
/* Button Code Definitions for the sansa fuze plus target */
...
#if 0 //#ifdef HAVE_HOTKEY on some gesture later?
...
static const struct button_mapping button_context_settings[] = {
    ...
    { ACTION_SETTINGS_DECBIGSTEP, BUTTON_BOTTOMLEFT,                 BUTTON_NONE },
    { ACTION_SETTINGS_DECBIGSTEP, BUTTON_BOTTOMLEFT|BUTTON_REPEAT,   BUTTON_NONE },

    { ACTION_SETTINGS_DEC,        BUTTON_DOWN,                       BUTTON_NONE },
    { ACTION_SETTINGS_DECREPEAT,  BUTTON_DOWN|BUTTON_REPEAT,         BUTTON_NONE },

    { ACTION_SETTINGS_INCBIGSTEP, BUTTON_BOTTOMRIGHT,                BUTTON_NONE },
    { ACTION_SETTINGS_INCBIGSTEP, BUTTON_BOTTOMRIGHT|BUTTON_REPEAT,  BUTTON_NONE },
...
#endif
#endif
        case CONTEXT_TREE:                      { return button_context_tree; }
