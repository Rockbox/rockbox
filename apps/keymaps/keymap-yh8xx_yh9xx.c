...
static const struct button_mapping button_context_standard[] = {
    ...
    { ACTION_STD_QUICKSCREEN,   BUTTON_LEFT|BUTTON_DOWN|BUTTON_REPEAT, BUTTON_LEFT|BUTTON_DOWN|BUTTON_REPEAT },
    { ACTION_STD_MENU,          BUTTON_LEFT|BUTTON_UP|BUTTON_REPEAT,   BUTTON_LEFT|BUTTON_UP },
...
static const struct button_mapping button_context_wps[] = {
    ...
    /* kludge: pressing 2 directional buttons is easy on this target  */
    { ACTION_WPS_QUICKSCREEN,   BUTTON_LEFT|BUTTON_DOWN|BUTTON_REPEAT,  BUTTON_LEFT|BUTTON_DOWN|BUTTON_REPEAT },
...
#else
    { ACTION_WPS_HOTKEY,        BUTTON_RIGHT|BUTTON_DOWN|BUTTON_REPEAT, BUTTON_RIGHT|BUTTON_DOWN|BUTTON_REPEAT },
...
#else
    { ACTION_TREE_HOTKEY, BUTTON_RIGHT|BUTTON_DOWN|BUTTON_REPEAT, BUTTON_RIGHT|BUTTON_DOWN|BUTTON_REPEAT },
#endif
...
const struct button_mapping* get_context_mapping(int context)
{
    switch (context)
    {
        ...
        case CONTEXT_SETTINGS_COLOURCHOOSER:    { return button_context_settings_right_is_inc; }
