...
static const struct button_mapping button_context_listtree_scroll_with_combo[]  = {
    { ACTION_TREE_PGLEFT,       BUTTON_FFWD|BUTTON_LEFT,               BUTTON_NONE },
    { ACTION_TREE_PGLEFT,       BUTTON_FFWD|BUTTON_LEFT|BUTTON_REPEAT, BUTTON_NONE },
    /* Note: we omit ACTION_TREE_ROOT_INIT and just use "left" as cancel button */
...
static const struct button_mapping button_context_listtree_scroll_without_combo[]  = {
    { ACTION_TREE_PGLEFT,       BUTTON_REW,                     BUTTON_NONE },
...
#ifdef SAMSUNG_YH820
    { ACTION_NONE,              BUTTON_REC,                     BUTTON_NONE },
#endif
...
#else
    { ACTION_KBD_BACKSPACE,    BUTTON_FFWD|BUTTON_DOWN,         BUTTON_NONE },
    { ACTION_KBD_BACKSPACE,    BUTTON_FFWD|BUTTON_DOWN|BUTTON_REPEAT,  BUTTON_NONE },
    { ACTION_KBD_ABORT,        BUTTON_REW|BUTTON_REPEAT,        BUTTON_NONE },
#endif
    { ACTION_KBD_MORSE_INPUT,  BUTTON_FFWD|BUTTON_UP,           BUTTON_NONE },
...
static const struct button_mapping button_context_morse_input[]  = {
    ...
    /* It would be nice to have a separate action for the morse key press-down...
       Note that the usual KBD_SELECT (play button) isn't deactivated to preserve
       backspace with the familiar button when the cursor is on the edit line. */
    { ACTION_KBD_SELECT,       BUTTON_UP,                       BUTTON_NONE },
    { ACTION_KBD_MORSE_SELECT, BUTTON_UP|BUTTON_REL,            BUTTON_NONE },

    LAST_ITEM_IN_LIST__NEXTLIST(CONTEXT_KEYBOARD)
...
static const struct button_mapping button_context_radio[]  = {
    ...
    { ACTION_FM_RECORD,         BUTTON_REC_SW_ON,               BUTTON_NONE },
    { ACTION_SETTINGS_INC,      BUTTON_UP,                      BUTTON_NONE },
    { ACTION_SETTINGS_INCREPEAT,BUTTON_UP|BUTTON_REPEAT,        BUTTON_NONE },
    { ACTION_SETTINGS_DEC,      BUTTON_DOWN,                    BUTTON_NONE },
    { ACTION_SETTINGS_DECREPEAT,BUTTON_DOWN|BUTTON_REPEAT,      BUTTON_NONE },
...
static const struct button_mapping button_context_usb_hid_mode_mouse[] = {
    ...
    { ACTION_USB_HID_MOUSE_WHEEL_SCROLL_UP,   BUTTON_FFWD|BUTTON_UP,       BUTTON_NONE },
    { ACTION_USB_HID_MOUSE_WHEEL_SCROLL_UP,   BUTTON_FFWD|BUTTON_UP|BUTTON_REPEAT,   BUTTON_NONE },
    { ACTION_USB_HID_MOUSE_WHEEL_SCROLL_DOWN, BUTTON_FFWD|BUTTON_DOWN,     BUTTON_NONE },
    { ACTION_USB_HID_MOUSE_WHEEL_SCROLL_DOWN, BUTTON_FFWD|BUTTON_DOWN|BUTTON_REPEAT, BUTTON_NONE },
#endif
