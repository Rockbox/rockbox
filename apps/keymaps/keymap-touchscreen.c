...
static const struct button_mapping button_context_quickscreen[] = {
    ...
    { ACTION_STD_CANCEL, BUTTON_TOPLEFT|BUTTON_REL,         BUTTON_NONE },
    { ACTION_STD_CANCEL, BUTTON_TOPRIGHT|BUTTON_REL,        BUTTON_NONE },
...
static const struct button_mapping button_context_pitchscreen[] = {
    ...
    { ACTION_PS_EXIT,           BUTTON_BOTTOMLEFT,                 BUTTON_NONE },
    ...
    { ACTION_PS_TOGGLE_MODE,    BUTTON_TOPRIGHT,                   BUTTON_NONE },
