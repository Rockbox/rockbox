...
{
    { ACTION_STD_KEYLOCK,        BUTTON_POWER|BUTTON_PLAY,           BUTTON_POWER },
...
{
    { ACTION_SETTINGS_INCBIGSTEP, BUTTON_PLAY|BUTTON_SCROLL_BACK,    BUTTON_NONE },
    { ACTION_SETTINGS_DECBIGSTEP, BUTTON_PLAY|BUTTON_SCROLL_FWD,     BUTTON_NONE },
...
static const struct button_mapping button_context_quickscreen[] =
{
    ...
    { ACTION_QS_LEFT,    BUTTON_PREV|BUTTON_REL,             BUTTON_NONE },
