...
#include "system.h"
#include "settings.h"
#include "dsp_core.h" /* for DSP_MAX_OUTPUT_FREQUENCY */
#include "pcm.h"
#include "pcm_mixer.h"
#include "misc.h"
...
#define BEEP_BUF_COUNT  BEEP_COUNT(HW_SAMPR_MAX, KEYCLICK_DURATION)
               ...
               unsigned int amplitude)
{
    ...
    uint32_t fout = mixer_get_samplerate();
    beep_phase = 0;
    beep_step = 0xffffffffu / fout * frequency;
