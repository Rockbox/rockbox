...
int mask = global_settings.bt_selective_softlock_actions_mask;
            struct s_mask_items maskitems[]={
                                       {ID2P(LANG_SOFTLOCK_ALLOW_VOLUME), SEL_ACTION_VOL},
                                       {ID2P(LANG_SOFTLOCK_ALLOW_PLAY),   SEL_ACTION_PLAY},
                                       {ID2P(LANG_SOFTLOCK_ALLOW_SEEK),   SEL_ACTION_SEEK},
                                       {ID2P(LANG_SOFTLOCK_ALLOW_SKIP),   SEL_ACTION_SKIP},
