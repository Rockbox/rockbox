                                        ...
                                        const struct menu_item_ex *this_item)
{
    ...
    switch (action)
    {
        ...
        if (global_settings.bl_selective_softlock_actions != false)
        {
        int mask=global_settings.bl_selective_softlock_actions_mask;
        ...
        global_settings.bl_selective_softlock_actions_mask=mask;
                                                
        }
        else global_settings.bl_selective_softlock_actions_mask=0; /* disabled */
...
#ifndef HAS_BUTTON_HOLD
MENUITEM_SETTING(bl_selective_softlock_actions,
                    &global_settings.bl_selective_softlock_actions,
