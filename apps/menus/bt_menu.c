...
#define BT_DEVICE_SCAN_MAX_DEVICES 6 /*(64 x 6) 384 bytes*/
...
enum bt_scanexp_menu{BT_SXMENU_CONNECT = 0, BT_SXMENU_PROFILE, BT_SXMENU_FORGET};
...
const struct bt_menu_items bt_menu_scan_exp[] =
{
    ...
    [BT_SXMENU_FORGET]     = BT_ITEM(LANG_BLUETOOTH_FORGET, Icon_NOICON),
};
