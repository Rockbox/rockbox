...
MENUITEM_SETTING(shuffled_adding, &global_settings.shuffled_adding, NULL);
MENUITEM_SETTING(queue_options, &global_settings.queue_options, NULL);
MAKE_MENU(currentplaylist_settings_menu, ID2P(LANG_CURRENT_PLAYLIST),
          NULL, Icon_Playlist,
          &warn_on_erase, &shuffled_adding, &queue_options);
