...
#if CONFIG_RTC
        /* announce the time */
        strcpy(infotemplate, "Dx");
#else
        /* announce elapsed play for this track */
        strcpy(infotemplate, "To");
#endif
    }
    ...
    while (*current_token != 0 && *current_token != '.')
    {
        ...
        if (current_char == 'D')
        {
            ...
            */
            ...
            if (valid_time(tm))
            {
                ...
                {
                    /* Time xxx */
                    (void)voice_info_group("StDt");
                }
                else if (current_char == 'Y')
                {
                    /* Date xxx */
                    (void)voice_info_group("SdDd");
                }
                else if (current_char == 'c')
                {
                    /* Date Time */
                    (void)voice_info_group("DdDt");
                }
            }
#endif
        ...
        else if (current_char == 'T')
        {
            ...
            */
            ...
            else if (current_char == 'S')
            {
                ...
                (void)voice_info_group("TeSeTrSr");
            }
            else if (current_char == 'O')
            {
                /* xxx of yyy */
                (void)voice_info_group("TeSoTl");
            }
        }
        else if (current_char == 'P')
        {
            ...
            */
            ...
            else if (current_char == 'S')
            {
                ...
                (void)voice_info_group("SrPcSoSn");
            }
        }
        else if (current_char == 'B')
        {
            ...
            */
            ...
            {
                /* BATTERY LEVEL battery level percent PERCENT */
                (void)voice_info_group("SbBp");
                talk_id(VOICE_PERCENT, true);
            }
            else if (current_char == 'R')
            {
                /* BATTERY LEVEL battery level in minutes */
                (void)voice_info_group("SbBm");
            }
