                                     ...
                                     char *buffer, size_t buffer_len)
{
    ...
    switch(selected_item)
    {
        ...
        case 2:
            ...
            break;
        case 3:
            snprintf(buffer, buffer_len, "Memory usage: %ld.%02ld KB",
                    talk_data->memory_usage / 1024, talk_data->memory_usage % 1024);
            break;
        case 4:
...
static bool dbg_talk(void)
{
    ...
    if (talk_get_debug_data(&data))
        simplelist_info_init(&list, "Voice Information:", 6, &data);
    else
