...
int action_select(int actmask, char* headermsg)
{
    ...
    static struct child action_child[5];
            action_child[0].name = "Volume + / -";
            action_child[0].category = &empty;
            action_child[0].key_value=SEL_ACTION_VOL;
            action_child[0].state = action_child[0].key_value & actmask ?
                                                SELECTED : DESELECTED;
            action_child[1].name = "Play";
            action_child[1].category = &empty;
            action_child[1].key_value=SEL_ACTION_PLAY;
            action_child[1].state = action_child[1].key_value & actmask ?
                                                SELECTED : DESELECTED;
            action_child[2].name = "Stop";
            action_child[2].category = &empty;
            action_child[2].key_value=SEL_ACTION_STOP;
            action_child[2].state = action_child[2].key_value & actmask ?
                                                SELECTED : DESELECTED;
            action_child[3].name = "Seek";
            action_child[3].category = &empty;
            action_child[3].key_value=SEL_ACTION_SEEK;
            action_child[3].state = action_child[3].key_value & actmask ?
                                                SELECTED : DESELECTED;
            action_child[4].name = "Skip";
            action_child[4].category = &empty;
            action_child[4].key_value=SEL_ACTION_SKIP;
            action_child[4].state = action_child[4].key_value & actmask ?
                                                SELECTED : DESELECTED;
