                           ...
                           int *intval)
{
    ...
    switch (token->type)
    {
        ...
        case SKIN_TOKEN_LIST_TITLE_ICON:
            ...
            snprintf(buf, buf_size, "%d", intret);
            bufret = buf;
            goto ret_intval;
        ...
        case SKIN_TOKEN_RTC_HOUR_24_ZERO_PADDED:
            /* H: hour (00..23) */
            intret = tm->tm_hour;
            snprintf(buf, buf_size, "%02d", intret);
            bufret = buf;
            goto ret_intval;
        ...
        case SKIN_TOKEN_RTC_HOUR_24:
            /* k: hour ( 0..23) */
            intret = tm->tm_hour;
            snprintf(buf, buf_size, "%2d", intret);
            bufret = buf;
            goto ret_intval;
        ...
        case SKIN_TOKEN_RTC_YEAR_4_DIGITS:
            ...
            snprintf(buf, buf_size, "%04d", intret);
            bufret = buf;
            goto ret_intval;
        ...
        case SKIN_TOKEN_SOUND_PITCH:
        {
            ...
            if (intval)
                intret = pitch_speed_enum(limit, pitch, PITCH_SPEED_PRECISION * 100);
            bufret = buf;
            goto ret_intval;
        }
#endif
    ...
    case SKIN_TOKEN_SOUND_SPEED:
    {
        ...
        if (intval)
            intret = pitch_speed_enum(limit, speed, PITCH_SPEED_PRECISION * 100);
        bufret = buf;
        goto ret_intval;
    }
#endif
