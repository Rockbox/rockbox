 ...
 *      'const char *'
 *
 * $s and $S support the following two forms:
 * $n[sS] - inserts n columns (pixels/chars respectively) of empty space
 * $*[sS] - inserts n columns (pixels/chars respectively) of empty space. put_line()
