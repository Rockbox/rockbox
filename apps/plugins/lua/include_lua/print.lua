...
--------------------------------------------------------------------------------
   ...
   -- Internal print function
    local function print_internal(t_opts, x, w, h, msg)
        ...
        if rb.LCD_DEPTH  == 2 or not rb.lcd_set_background and -- 1 bit display targets
                linestyle > 0 and linestyle ~= rb.STYLE_DEFAULT then
            linestyle = rb.STYLE_INVERT
        end
