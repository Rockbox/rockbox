 ...
 ****************************************************************************/
--
temp loader allows some (pure) lua requires to be loaded and later garbage collected
unfortunately the 'required' module needs to be formatted in such a way to pass back a reference
to a function or call table in order to keep the functions within from being
