...
const struct button_mapping pla_remote_ctx[] =
{
    ...
    { PLA_UP_REL,            BUTTON_RC_BITRATE|BUTTON_REL,     BUTTON_NONE},
    { PLA_DOWN_REL,          BUTTON_RC_SOURCE|BUTTON_REL,      BUTTON_NONE},
    { PLA_LEFT_REL,          BUTTON_RC_VOL_DOWN|BUTTON_REL,    BUTTON_NONE},
    { PLA_RIGHT_REL,         BUTTON_RC_VOL_UP|BUTTON_REL,      BUTTON_NONE},
    ...
    { PLA_LEFT,              BUTTON_RC_VOL_DOWN,               BUTTON_NONE},
    { PLA_RIGHT,             BUTTON_RC_VOL_UP,                 BUTTON_NONE},
    { PLA_UP_REL,            BUTTON_RC_FF|BUTTON_REL,          BUTTON_NONE},
    { PLA_DOWN_REL,          BUTTON_RC_REW|BUTTON_REL,         BUTTON_NONE},
    { PLA_LEFT_REL,          BUTTON_RC_VOL_DOWN|BUTTON_REL,    BUTTON_NONE},
    { PLA_RIGHT_REL,         BUTTON_RC_VOL_UP|BUTTON_REL,      BUTTON_NONE},
    ...
    { PLA_UP_REL,            BUTTON_RC_VOL_UP|BUTTON_REL,      BUTTON_NONE},
    { PLA_DOWN_REL,          BUTTON_RC_VOL_DOWN|BUTTON_REL,    BUTTON_NONE},
    { PLA_LEFT_REL,          BUTTON_RC_LEFT|BUTTON_REL,        BUTTON_NONE},
    { PLA_RIGHT_REL          BUTTON_RC_RIGHT|BUTTON_REL,       BUTTON_NONE},
    ...
    { PLA_UP_REL,            BUTTON_RC_PLAY|BUTTON_REL,        BUTTON_NONE},
    { PLA_DOWN_REL,          BUTTON_RC_DOWN|BUTTON_REL,        BUTTON_NONE},
    { PLA_LEFT_REL,          BUTTON_RC_REW|BUTTON_REL,         BUTTON_NONE},
    { PLA_RIGHT_REL,         BUTTON_RC_FF|BUTTON_REL,          BUTTON_NONE},
...
const struct button_mapping pla_main_ctx[] = 
{
    ...
    { PLA_UP_REL,           BUTTON_TOPMIDDLE|BUTTON_REL,        BUTTON_NONE},
    { PLA_DOWN_REL,         BUTTON_BOTTOMMIDDLE|BUTTON_REL,     BUTTON_NONE},
    { PLA_LEFT_REL,         BUTTON_MIDLEFT|BUTTON_REL,          BUTTON_NONE},
    { PLA_RIGHT_REL,        BUTTON_MIDRIGHT|BUTTON_REL,         BUTTON_NONE},
    ...
    { PLA_UP_REL,           BUTTON_UP|BUTTON_REL,               BUTTON_NONE },
    { PLA_DOWN_REL,         BUTTON_DOWN|BUTTON_REL,             BUTTON_NONE },
    { PLA_LEFT_REL,         BUTTON_LEFT|BUTTON_REL,             BUTTON_NONE },
    { PLA_RIGHT_REL,        BUTTON_RIGHT|BUTTON_REL,            BUTTON_NONE },
    ...
    { PLA_LEFT,             BUTTON_LEFT,                        BUTTON_NONE },
    { PLA_RIGHT,            BUTTON_RIGHT,                       BUTTON_NONE },
    { PLA_UP_REL,           BUTTON_MENU|BUTTON_REL,             BUTTON_NONE },
    { PLA_DOWN_REL,         BUTTON_PLAY|BUTTON_REL,             BUTTON_NONE },
    { PLA_LEFT_REL,         BUTTON_LEFT|BUTTON_REL,             BUTTON_NONE },
    { PLA_RIGHT_REL,        BUTTON_RIGHT|BUTTON_REL,            BUTTON_NONE },
    ...
    { PLA_LEFT,             BUTTON_LEFT,                        BUTTON_NONE },
    { PLA_RIGHT,            BUTTON_RIGHT,                       BUTTON_NONE },
    { PLA_UP_REL,           BUTTON_PLAY|BUTTON_REL,             BUTTON_NONE },
    { PLA_DOWN_REL,         BUTTON_STOP|BUTTON_REL,             BUTTON_NONE },
    { PLA_LEFT_REL,         BUTTON_LEFT|BUTTON_REL,             BUTTON_NONE },
    { PLA_RIGHT_REL,        BUTTON_RIGHT|BUTTON_REL,            BUTTON_NONE },
    ...
    { PLA_LEFT,             BUTTON_LEFT,                        BUTTON_NONE },
    { PLA_RIGHT,            BUTTON_RIGHT,                       BUTTON_NONE },
    { PLA_UP_REL,           BUTTON_SCROLL_UP|BUTTON_REL,        BUTTON_NONE },
    { PLA_DOWN_REL,         BUTTON_SCROLL_DOWN|BUTTON_REL,      BUTTON_NONE },
    { PLA_LEFT_REL,         BUTTON_LEFT|BUTTON_REL,             BUTTON_NONE },
    { PLA_RIGHT_REL,        BUTTON_RIGHT|BUTTON_REL,            BUTTON_NONE },
    ...
    { PLA_LEFT,             BUTTON_LEFT,                        BUTTON_NONE },
    { PLA_RIGHT,            BUTTON_RIGHT,                       BUTTON_NONE },
    { PLA_UP_REL,           BUTTON_VOL_UP|BUTTON_REL,           BUTTON_NONE },
    { PLA_DOWN_REL,         BUTTON_VOL_DOWN|BUTTON_REL,         BUTTON_NONE },
    { PLA_LEFT_REL,         BUTTON_LEFT|BUTTON_REL,             BUTTON_NONE },
    { PLA_RIGHT_REL,        BUTTON_RIGHT|BUTTON_REL,            BUTTON_NONE },
    ...
    { PLA_UP_REL,           BUTTON_UP|BUTTON_REL,               BUTTON_NONE },
    { PLA_DOWN_REL,         BUTTON_DOWN|BUTTON_REL,             BUTTON_NONE },
    { PLA_LEFT_REL,         BUTTON_PREV|BUTTON_REL,             BUTTON_NONE },
    { PLA_RIGHT_REL,        BUTTON_NEXT|BUTTON_REL,             BUTTON_NONE },
    { PLA_UP_REPEAT,        BUTTON_UP|BUTTON_REPEAT,            BUTTON_NONE },
    { PLA_DOWN_REPEAT,      BUTTON_DOWN|BUTTON_REPEAT,          BUTTON_NONE },
    ...
    { PLA_LEFT,             BUTTON_LEFT,                        BUTTON_NONE },
    { PLA_RIGHT,            BUTTON_RIGHT,                       BUTTON_NONE },
    { PLA_UP_REL,           BUTTON_STOP|BUTTON_REL,             BUTTON_NONE },
    { PLA_DOWN_REL,         BUTTON_PLAY|BUTTON_REL,             BUTTON_NONE },
    { PLA_LEFT_REL,         BUTTON_LEFT|BUTTON_REL,             BUTTON_NONE },
    { PLA_RIGHT_REL,        BUTTON_RIGHT|BUTTON_REL,            BUTTON_NONE },
    ...
    { PLA_UP_REL,            BUTTON_REW|BUTTON_REL,             BUTTON_NONE},
    { PLA_DOWN_REL,          BUTTON_FF|BUTTON_REL,              BUTTON_NONE},
    { PLA_LEFT_REL,          BUTTON_VOL_DOWN|BUTTON_REL,        BUTTON_NONE},
    { PLA_RIGHT_REL,         BUTTON_VOL_UP|BUTTON_REL,          BUTTON_NONE},
    ...
    { PLA_UP_REL,            BUTTON_UP|BUTTON_REL,              BUTTON_NONE},
    { PLA_DOWN_REL,          BUTTON_DOWN|BUTTON_REL,            BUTTON_NONE},
    { PLA_LEFT_REL,          BUTTON_REW|BUTTON_REL,             BUTTON_NONE},
    { PLA_RIGHT_REL,         BUTTON_FF|BUTTON_REL,              BUTTON_NONE},
    { PLA_UP_REPEAT,         BUTTON_UP|BUTTON_REPEAT,           BUTTON_NONE},
    { PLA_DOWN_REPEAT,       BUTTON_DOWN|BUTTON_REPEAT,         BUTTON_NONE},
