...
const struct button_mapping pla_main_ctx[] =
{
    ...
    { PLA_LEFT,             BUTTON_WHEEL_CCW,                   BUTTON_NONE },
    { PLA_RIGHT,            BUTTON_WHEEL_CW,                    BUTTON_NONE },
    { PLA_UP_REPEAT,        BUTTON_NEXT|BUTTON_REPEAT,          BUTTON_NONE },
    { PLA_DOWN_REPEAT,      BUTTON_PREV|BUTTON_REPEAT,          BUTTON_NONE },
//    { PLA_LEFT_REPEAT,      BUTTON_WHEEL_CCW|BUTTON_REPEAT,          BUTTON_NONE },
//    { PLA_RIGHT_REPEAT,     BUTTON_WHEEL_CW|BUTTON_REPEAT,          BUTTON_NONE },
