...
#if LCD_DEPTH == 2
        src = rb->_viewport_get_framebuffer(NULL, NULL) + _GREY_MULUQ(LCD_FBWIDTH, y);
...
#if LCD_DEPTH == 1
        mask = BIT_N(y & 7);
        src = rb->_viewport_get_framebuffer(NULL, NULL) + _GREY_MULUQ(LCD_WIDTH, y >> 3);
...
#elif LCD_DEPTH == 2
        shift = 2 * (y & 3);
        src = rb->_viewport_get_framebuffer(NULL, NULL) + _GREY_MULUQ(LCD_WIDTH, y >> 2);
