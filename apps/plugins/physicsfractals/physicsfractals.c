...
****************************************************************************
    ...
    **Classic Four Quantum Numbers**
    ...
    QNspin              =  ...+2,+1,0,-1-2...
                          ...
                          XOR at half of W with the other half of W
                          A middle row cancles out for obvious reason

                          A bisecting 90 degree cut of the 2D brane
                          assign charge - and +
...
The  Truth Table
    ...
    boolean logic is at play OR and NOT etc
    This can be replced with blits and bit shifts of the brane
...
So is redundancy built into the number system defined?
   ...
   ____cut______
    ...
    And just OR it back from whats left
...
// Begin Q-bit
// With adjustments to avoid null, n=(0, 1) could be typed
//            as static and projected on a matrix of size n(2^n)
//            to define any brane of n that fits in max memory
// Todo: Find Max Memory

#define QBIT_1D 2

static const struct point_2D qbit_zero[QBIT_1D] =
{
    {{0}},
    {{0}}
};

static const struct point_2D qbit_one[QBIT_1D] =
{
    {{0}},
    {{1}}
};

// Begin define N brane
