...
A Visual String Theroy Physics Simulator of the Elements
...
The Truth Table
    ...
    seg_counter=2
        ...
        {{1, 0, 0, 1}}
        {{0, 1, 1, 0}}____//Half way point;end  rule1;endrule2
...
Memory Requirements
  ...
  to itenerate the formulas above maximally in memory using blits bit shifts ORs etc
...
unsigned short int c = 0;  //counter1
