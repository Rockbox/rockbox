...
****************************************************************************
    ...
    **Classic Four Quantum Numbers**
    ...
    QNspin              =  ...+2,+1,0,-1-2...
                          ...
                          XOR at half of W
                          bisecting 90degree angles of the 2D brane
                          assign charge
...
QUANTUM SPIN
    ...
    XOR at half of W and SUM over SUM top half and bottem

    This set {-2, +2} and last set {-1, 0, +1} equals {-2, -1, 0, +1, +2}
