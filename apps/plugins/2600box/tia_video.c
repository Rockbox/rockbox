...
void init_tia (void)
{
    ...
    colour_table[P0M0_COLOUR]= vcs_palette[0];
    colour_table[P1M1_COLOUR]= vcs_palette[0];
    colour_table[PFBL_COLOUR] = vcs_palette[0];
    colour_table[BK_COLOUR] = vcs_palette[0];
#else
    colour_table[P0M0_COLOUR]= vcs_palette[0];
    colour_table[P1M1_COLOUR]= vcs_palette[0];
    colour_table[PFBL_COLOUR] = vcs_palette[0];
