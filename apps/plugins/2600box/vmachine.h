...
#define TV_SCREEN_WIDTH     160

#include "rb_test.h" // must be included ...
...
extern fb_data tv_screen[TV_SCREEN_HEIGHT][TV_SCREEN_WIDTH];
#else
/* old version */
extern UINT32 tv_screen[TV_SCREEN_HEIGHT][TV_SCREEN_WIDTH];
#endif
