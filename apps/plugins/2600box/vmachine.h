...
extern int tia_register;    /* set to negative for "no tia write access" */
extern int tia_value;

extern BYTE keypad[2][4];

extern int tia_delay;
...
#define TV_STATE_BLANK              8   /* set to blank screen on purpose */
#define TV_BLANK_COLOUR     0x01    // colour to set if screen in blanked
