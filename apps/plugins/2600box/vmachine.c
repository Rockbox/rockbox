...
extern inline void init_screen (void)
{
...
extern inline void init_riot (void)
{
  int i;
...
extern inline void init_tia (void)
{
  int i;
  for(i=0; i< 0x2d;i++)
    {
...
extern inline void init_memory(void)
{
  int i;
  for(i=0;i<1024; i++)
    cartRam[i]=0;
...
extern inline void init_banking (void)
{
...
extern inline void init_cpu( ADDRESS addr);
...
/* Do a raster change */
extern inline void do_raster_change (int i, int type, int val, struct RasterChange *rc)
{
  i = i;
  if (beamadj == 0)
    {
...
/* type: type of change */
/* val: value of change */
extern inline void do_unified_change (int type, int val)
{
...
/* type: type of change */
/* val: value of change */
extern inline void do_plraster_change (int i, int type, int val)
{
...
/* type: type of change */
/* val: value of change */
extern inline void do_pfraster_change (int i, int type, int val)
{
...
extern inline void use_unified_change (struct RasterChange *rc)
{
  switch (rc->type)
    {
    case 0:
...
/* rc: change to make */
extern inline void use_pfraster_change (struct PlayField *pl, struct RasterChange *rc)
{
  switch (rc->type)
    {
    case 0:
...
/* pl: player to change */
/* rc: change to make */
extern inline void  use_plraster_change (struct Player *pl, struct RasterChange *rc)
{
  switch (rc->type)
    {
    case 0:
...
extern inline void set_timer (int res, int count, int clkadj)
{
...
extern inline BYTE do_timer (int clkadj)
{
  BYTE result;
  int delta;
  int value;
...
/* b: the byte written */
extern inline void do_vblank (BYTE b)
{
  if (b & 0x02)
    {
...
extern inline void do_hsync (void)
{
...
extern inline  void do_screen (int clks)
{
  switch (vbeam_state)
    {
    case VSYNCSTATE:
