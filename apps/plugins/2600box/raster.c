...
fb_data colour_table[4];
#else
UINT32 colour_table[4];
#endif
...
#elif COLOUR_HANDLING==1
    fb_data *tv_ptr = &tv_screen[ebeamy][xmin];
#endif
...
#elif COLOUR_HANDLING==1
        /* use RB FB for colour_table, render TV framebuf as RB FB type */
        int colind = colour_lookup[object_mask];
        *tv_ptr++ = colour_table[colind];
#endif
...
#elif COLOUR_HANDLING==1
        colour_table[P0M0_COLOUR] = vcs_palette[b];
#endif
        break;
    case COLUP1:
        /* P1M1 colour */
...
#elif COLOUR_HANDLING==1
        colour_table[P1M1_COLOUR] = vcs_palette[b];
#endif
        break;
    case COLUPF:
        /* PFBL colour */
...
#elif COLOUR_HANDLING==1
        colour_table[PFBL_COLOUR] = vcs_palette[b];
#endif
        break;
    case COLUBK:
#if COLOUR_HANDLING==0
...
#elif COLOUR_HANDLING==1
        colour_table[BK_COLOUR] = vcs_palette[b];
#endif
        break;
    case CTRLPF:
        /* set ball size */
