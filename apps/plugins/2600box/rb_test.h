...
/* colour and framebuffer handling:
 *  0   as far as possible the native VCS colours are used (8 bit).
 *      Translation in rgb is only done when writing to RB frame buffer.
 *  1   use native RB framebuffer format for TV framebuffer and everything else
 *  >1  use old handling. TO BE REMOVED LATER!
 */
#define COLOUR_HANDLING 0
