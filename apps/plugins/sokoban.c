...
#define SOKOBAN_UP           BUTTON_UP
#define SOKOBAN_DOWN         BUTTON_DOWN
#define SOKOBAN_MENU         BUTTON_BACK
#define SOKOBAN_UNDO         (BUTTON_POWER|BUTTON_LEFT)
#define SOKOBAN_REDO         (BUTTON_POWER|BUTTON_RIGHT)
#define SOKOBAN_LEVEL_DOWN   (BUTTON_POWER|BUTTON_DOWN)
#define SOKOBAN_LEVEL_UP     (BUTTON_POWER|BUTTON_UP)
#define SOKOBAN_LEVEL_REPEAT (BUTTON_POWER|BUTTON_PLAY)
#define SOKOBAN_PAUSE        BUTTON_PLAY
#define BUTTON_SAVE          BUTTON_PLAY
#define BUTTON_SAVE_NAME    "Play"
