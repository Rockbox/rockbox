...
// if not ARMv5
#if !(defined(CPU_ARM) && ARCH_VERSION >= 5 && (CONFIG_PLATFORM & PLATFORM_NATIVE))
INLINE void SND_PaintChannelFrom8 (int true_lvol, int true_rvol, signed char *sfx, int count)
{
        int     data;
        int             i;
...
INLINE void SND_PaintChannelFrom16 (int true_lvol, int true_rvol, signed short *sfx, int count)
{
        int data;
        int left, right;
        int     i;
