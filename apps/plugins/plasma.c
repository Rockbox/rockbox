...
#if defined(HAVE_LCD_MODES) && (HAVE_LCD_MODES & LCD_MODE_PAL256)
        ptr = (unsigned char*)rb->_viewport_get_framebuffer(NULL, NULL);
#else
        ptr = rb->_viewport_get_framebuffer(NULL, NULL);
#endif
...
#ifdef HAVE_LCD_COLOR
#if defined(HAVE_LCD_MODES) && (HAVE_LCD_MODES & LCD_MODE_PAL256)
        rb->lcd_blit_pal256(    (unsigned char*)rb->_viewport_get_framebuffer(NULL, NULL),
