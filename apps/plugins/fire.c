...
#define FIRE_SWITCH_FLAMES_TYPE PLA_FIRE
#define FIRE_SWITCH_FLAMES_MOVING PLA_START
#if (CONFIG_KEYPAD == IPOD_4G_PAD) || (CONFIG_KEYPAD == IPOD_3G_PAD) || \
      (CONFIG_KEYPAD == IPOD_1G2G_PAD)
#define FIRE_INCREASE_MULT PLA_RIGHT
#define FIRE_DECREASE_MULT PLA_LEFT
#else
...
int main(void)
{
    ...
    while (true){
        ...
        action = pluginlib_getaction(rb, 0, plugin_contexts, 1);
