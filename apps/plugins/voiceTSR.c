    ...
    else if ((action == ACTION_STD_OK))
    {
        ...
        switch(selection) {
            ...
            case 8: /*Clear All*/
                ...
                break;
            case 9: /* inspect it */
                rb->kbd_input(gAnnounce.wps_fmt, MAX_ANNOUNCE_WPS, NULL);
                break;
            case 10: /*test it*/
                announce_test();
                break;
...
int plugin_main(const void* parameter)
{
    ...
    g_info_reset_timeout = *rb->current_tick;
...
static int voice_general_info(bool testing)
{
    ...
    if (TIME_BEFORE(current_tick, g_info_reset_timeout))
    {
        return -2;
    }

    g_info_reset_timeout = current_tick + gAnnounce.interval * HZ;
    ...
    while (*current_token != 0)
    {
        ...
        else if (current_char == 'P')
        {
            ...
            */
            ...
            int current_track = _playlist_get_display_index(pl);
        ...
        else if (current_char == GROUPING_CHAR && gAnnounce.grouping > 0)
        {
            ...
            if (gAnnounce.count >= gAnnounce.grouping && !testing)
                break;      
