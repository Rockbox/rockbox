...
#define SUDOKU_BUTTON_QUIT       BUTTON_BACK
#define SUDOKU_BUTTON_MENU       (BUTTON_POWER|BUTTON_PLAY)
#define SUDOKU_BUTTON_UP         BUTTON_UP
#define SUDOKU_BUTTON_DOWN       BUTTON_DOWN
#define SUDOKU_BUTTON_LEFT       BUTTON_LEFT
#define SUDOKU_BUTTON_RIGHT      BUTTON_RIGHT
#define SUDOKU_BUTTON_TOGGLE     BUTTON_PLAY
#define SUDOKU_BUTTON_TOGGLEBACK (BUTTON_POWER|BUTTON_LEFT)
#define SUDOKU_BUTTON_POSSIBLE   (BUTTON_POWER|BUTTON_DOWN)
#define SUDOKU_BUTTON_ALTTOGGLE  (BUTTON_POWER|BUTTON_RIGHT)
