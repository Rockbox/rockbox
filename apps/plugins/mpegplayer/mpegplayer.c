                                           ...
                                           int width, int height)
{
    ...
    dst = rb->_viewport_get_framebuffer(NULL, NULL, SCREEN_MAIN) + (LCD_WIDTH - y) + x*LCD_WIDTH;
    do
    {
                                            ...
                                            int width, int height)
{
    ...
    dst_start = rb->_viewport_get_framebuffer(NULL, NULL, SCREEN_MAIN) + (LCD_WIDTH - y - 1) + x*LCD_WIDTH;
    int col, row = height;
