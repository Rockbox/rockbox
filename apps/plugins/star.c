...
#define STAR_DOWN           BUTTON_DOWN
#define STAR_TOGGLE_CONTROL BUTTON_PLAY
#define STAR_LEVEL_UP      (BUTTON_PLAY | BUTTON_MENU)
#define STAR_LEVEL_DOWN    (BUTTON_PLAY | BUTTON_BACK)
#define STAR_LEVEL_REPEAT  (BUTTON_PLAY | BUTTON_DOWN)
#define STAR_TOGGLE_CONTROL_NAME "PLAY"
#define STAR_QUIT_NAME      "POWER"
#define STAR_LEVEL_UP_NAME  "PLAY + MENU"
#define STAR_LEVEL_DOWN_NAME "PLAY + BACK"
#define STAR_LEVEL_REPEAT_NAME "PLAY + DOWN"
