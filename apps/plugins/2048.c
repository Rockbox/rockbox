...
/* FIXME: up and down are reversed for some reason */
/* Up
   3 
   2 ^ ^ ^ ^
   1 ^ ^ ^ ^
...
static void up(void)
{
  slide_internal(0, 2,  /* start values */
                 4, -1, /* stop values */
                 1, -1, /* delta values */
...
static void hs_check_update(void)
{
