...
#define ANIM_SLEEPTIME (HZ/20) /* time between frames */
#define GRID_SIZE 4
...
#define RAND_RANGE(min,max) (rb->rand()%(max-min)+min)
...
#define RESTORE_GRID() (memcpy(&ctx->grid, &old_grid, sizeof(ctx->grid)))
