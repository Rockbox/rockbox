...
#define PICO_GENERIC    0
#define PICO_Windows    1   /* Windows */
#define PICO_MacOSX     5   /* Macintosh OS X */
#define PICO_Linux      7   /* Linux */
#define PICO_ROCKBOX    9   /* Rockbox plugin */

/* * definition of current platform ***/
#if !defined(PICO_PLATFORM)
#if defined(ROCKBOX)
/* this must be at the top, otherwise compiling sim/host will skip this define */
#define PICO_PLATFORM PICO_ROCKBOX
#include "../sqrtf.h"
#elif defined(_WIN32)
...
#elif (PICO_PLATFORM == PICO_ROCKBOX)
#define PICO_PLATFORM_STRING "Rockbox"
