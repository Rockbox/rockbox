...
#define fgetpos _fgetpos_
#define fsetpos _fsetpos_
...
#undef fpos_t
#define fpos_t _fpos_t_
typedef long _fpos_t_;
...
int _fgetpos_(_FILE_ *stream, fpos_t *pos);
int _fsetpos_(_FILE_ *stream, fpos_t *pos);
