...
#define MATRIX_SLEEP_MORE          PLA_SCROLL_FWD
#define MATRIX_SLEEP_MORE_REPEAT   PLA_SCROLL_FWD_REPEAT
#define MATRIX_SLEEP_LESS          PLA_SCROLL_BACK
#define MATRIX_SLEEP_LESS_REPEAT   PLA_SCROLL_BACK_REPEAT
#else
...
enum plugin_status plugin_start(const void* parameter) {
    ...
    while (1) {
        ...
        button = pluginlib_getaction(frozen, plugin_contexts,
