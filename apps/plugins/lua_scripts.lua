...
local scrpath = rb.PLUGIN_DIR .. "/demos/lua_scripts/"

package.path = scrpath .. "/?.lua;" .. package.path --add the LuaExample directory to path
require("printtable")

rb.actions = nil
package.loaded["actions"] = nil

local excludedsrc = ";filebrowse.lua;fileviewers.lua;"
--------------------------------------------------------------------------------
