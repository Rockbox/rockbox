...
#define log2f log2f_wrapper
#define atan2 SDL_atan2
#define abort() fatal("aborted")
...
// causes conflicts with SDL_rwops
//#define close(f) rb->close(f)
...
//#define open(path, flag, ...) rb->open((path), (flag), ##__VA_ARGS__)
#define opendir rb->opendir
#define perror perror_wrapper
...
#endif
#define strnlen strnlen_wrapper
...
#define ldexp ldexp_wrapper
#define frexp frexp_wrapper
#define modf modf_wrapper
