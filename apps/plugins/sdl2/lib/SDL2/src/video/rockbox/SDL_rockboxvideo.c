...
#define RBSDL_UP_LEFT SDLK_KP_7
#define RBSDL_UP_RIGHT SDLK_KP_9
#define RBSDL_DOWN_LEFT SDLK_KP_1
#define RBSDL_DOWN_RIGHT SDLK_KP_3
...
static void rb_press(int sdl_sym, int raw) {
    (void) raw;

    SDL_SendKeyboardKey(SDL_PRESSED, sdl_sym);
}

static void rb_release(int sdl_sym, int raw) {
    (void) raw;
