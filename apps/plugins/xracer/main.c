...
bool project_segment(struct road_segment *base, struct road_segment *seg, int x, int dx, struct point_3d *camera, struct point_2d *p1, struct point_2d *p2, int *maxy)
{
