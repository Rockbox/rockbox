...
void add_road(struct road_segment *road, int idx, int len, int curve, int hill);

/* slope *must* be positive! for negative slopes, use add_downhill */
void add_uphill(struct road_segment *road, int idx, int slope, int hold, int curve);

/* slope *must* be negative! for positive slopes, use add_uphill */
void add_downhill(struct road_segment *road, int idx, int slope, int hold, int curve);
