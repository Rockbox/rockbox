...
#define XWORLD_SYS_PCM_FORMAT   PCM_FORMAT_T_PARM(PCM_FORMAT_S16_1CH_2I)

static unsigned long output_samplerate;
...
void sys_startAudio(struct System* sys, AudioCallback callback, void *param)
{
    ...
    output_samplerate = rb->pcm_get_frequency(pcm_handle);
    rb->pcm_play_data(pcm_handle, get_more, NULL, 0,
                      XWORLD_SYS_PCM_FORMAT);
}
