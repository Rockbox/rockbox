...
static void do_video_settings(void)
{
    ...
    while(1)
    {
        ...
        case 3:
            ...
            break;
        case 4:
            rb->set_option("Rotation", &rotation_option, INT, rotation_settings, 3, NULL);
            break;
        case 5:
            rb->lcd_clear_display();
            return;
