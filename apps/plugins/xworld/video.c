...
void video_saveOrLoad(struct Video* v, Serializer &ser) {
    ...
    Serializer::Entry entries[] = {
        ...
        SE_ARRAY(_pagePtrs[0], video_VID_PAGE_SIZE, Serializer::SES_INT8, VER(1)),
        SE_ARRAY(_pagePtrs[1], video_VID_PAGE_SIZE, Serializer::SES_INT8, VER(1)),
        SE_ARRAY(_pagePtrs[2], video_VID_PAGE_SIZE, Serializer::SES_INT8, VER(1)),
        SE_ARRAY(_pagePtrs[3], video_VID_PAGE_SIZE, Serializer::SES_INT8, VER(1)),
        SE_END()
    };
