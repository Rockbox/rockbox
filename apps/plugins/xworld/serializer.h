...
struct Serializer {
	...
	void ser_saveOrLoadEntries(struct Serializer*, Entry *entry);

	void ser_saveEntries(struct Serializer*, Entry *entry);
	void ser_loadEntries(struct Serializer*, Entry *entry);
