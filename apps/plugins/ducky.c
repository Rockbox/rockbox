 ...
 *            character. However, not all of them are addressable. The digit 0
 *            can NOT be used as a variable, but the other digits can be.
 *
 ...
 * "JUMPIF X == 0 *Y" - if X == 0, jump to line Y
 * "JUMPIF X != 0 *Y" - if X != 0, jump to line Y
 * "JUMPIF X < 0 *Y" - if X < 0, jump to line Y
 * "JUMPIF X > 0 *Y" - if X > 0, jump to line Y
 * "JUMPIF X <= 0 *Y" - if X <= 0, jump to line Y
 * "JUMPIF X >= 0 *Y" - if X >= 0, jump to line Y
 * "JUMPIF X < Y *Z" - if X < Y, jump to line Z
 * "JUMPIF X > Y *Z" - if X > Y, jump to line Z
 * "JUMPIF X <= Y *Z" - if X <= Y, jump to line Z
 * "JUMPIF X >= Y *Z" - if X >= Y, jump to line Z
 * "JUMPIF X == Y *Z" - if X == Y, jump to line Z
