...
enum
{
    SHOW_SHUFFLED_ADDING = 0,
    HIDE_SHUFFLED_ADDING
};
...
struct user_settings
{
    ...
    int shuffled_adding; /* how and whether to display options for adding shuffled tracks to dynamic playlist */
    int queue_options; /* how and whether to display options to queue tracks */
