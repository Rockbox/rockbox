...
enum {
    /* This is a little wonky, but necessary due to some unfortunate
       overloading of the first two elements.  Perhaps a better approach
       would be to split this into two distinct enums.. */
    BOOKMARK_NO = 0,
    BOOKMARK_YES = 1,
    BOOKMARK_ASK = 2,
