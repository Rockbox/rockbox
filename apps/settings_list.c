...
static void mbc3band_set(int val)
{
    (void)val;
    dsp_set_mbc3band(&global_settings.mbc3band_settings);
}

static void mbc3band_set_bool(bool val)
{
    (void)val;
    dsp_set_mbc3band(&global_settings.mbc3band_settings);
}
...
#undef EQ_BAND
    ...
    /* mbc3band */
    OFFON_SETTING(F_SOUNDSETTING, mbc3band_settings.enabled,
                  LANG_MBC3BAND_ENABLE, false,
                  "mbc3band enable", mbc3band_set_bool),
    CHOICE_SETTING(F_SOUNDSETTING|F_NO_WRAP, mbc3band_settings.mode,
                   LANG_MBC3BAND_MODE, MBC_MODE_1BAND,
                   "mbc3band mode",
                   "1 band,2 band,3 band", mbc3band_set, 3,
                   ID2P(LANG_MBC3BAND_1BAND),
                   ID2P(LANG_MBC3BAND_2BAND),
                   ID2P(LANG_MBC3BAND_3BAND)),
    INT_SETTING_NOWRAP(F_SOUNDSETTING, mbc3band_settings.crossover_low,
                       LANG_MBC3BAND_CO_LOW, 120,
                       "mbc3band crossover low", UNIT_INT, 40, 500,
                       10, NULL, NULL, mbc3band_set),
    INT_SETTING_NOWRAP(F_SOUNDSETTING, mbc3band_settings.crossover_high,
                       LANG_MBC3BAND_CO_HIGH, 2000,
                       "mbc3band crossover high", UNIT_INT, 500, 8000,
                       100, NULL, NULL, mbc3band_set),
    /* Band 0 - Low */
    INT_SETTING_NOWRAP(F_SOUNDSETTING, mbc3band_settings.bands[0].threshold,
                       LANG_MBC3BAND_THRESH_B0, -12,
                       "mbc3band b0 threshold", UNIT_DB, -60, 0,
                       3, NULL, NULL, mbc3band_set),
    CHOICE_SETTING(F_SOUNDSETTING|F_NO_WRAP, mbc3band_settings.bands[0].ratio_down,
                   LANG_MBC3BAND_RDOWN_B0, 2,
                   "mbc3band b0 ratio down",
                   "off,2:1,4:1,6:1,10:1,limit", mbc3band_set, 6,
                   ID2P(LANG_MBC3BAND_ROFF),
                   ID2P(LANG_MBC3BAND_R2),
                   ID2P(LANG_MBC3BAND_R4),
                   ID2P(LANG_MBC3BAND_R6),
                   ID2P(LANG_MBC3BAND_R10),
                   ID2P(LANG_MBC3BAND_RLIMIT)),
    CHOICE_SETTING(F_SOUNDSETTING|F_NO_WRAP, mbc3band_settings.bands[0].ratio_up,
                   LANG_MBC3BAND_RUP_B0, 0,
                   "mbc3band b0 ratio up",
                   "off,0.25:1,0.5:1,0.75:1", mbc3band_set, 4,
                   ID2P(LANG_MBC3BAND_ROFF),
                   ID2P(LANG_MBC3BAND_RU25),
                   ID2P(LANG_MBC3BAND_RU50),
                   ID2P(LANG_MBC3BAND_RU75)),
    INT_SETTING_NOWRAP(F_TIME_SETTING|F_SOUNDSETTING,
                       mbc3band_settings.bands[0].attack_ms,
                       LANG_MBC3BAND_ATT_B0, 10,
                       "mbc3band b0 attack", UNIT_MS, 1, 500,
                       5, NULL, NULL, mbc3band_set),
    INT_SETTING_NOWRAP(F_TIME_SETTING|F_SOUNDSETTING,
                       mbc3band_settings.bands[0].release_ms,
                       LANG_MBC3BAND_REL_B0, 100,
                       "mbc3band b0 release", UNIT_MS, 10, 2000,
                       10, NULL, NULL, mbc3band_set),
    INT_SETTING_NOWRAP(F_SOUNDSETTING, mbc3band_settings.bands[0].wet_mix,
                       LANG_MBC3BAND_MIX_B0, 100,
                       "mbc3band b0 wet mix", UNIT_PERCENT, 0, 100,
                       5, NULL, NULL, mbc3band_set),
    /* Band 1 - Mid */
    INT_SETTING_NOWRAP(F_SOUNDSETTING, mbc3band_settings.bands[1].threshold,
                       LANG_MBC3BAND_THRESH_B1, -18,
                       "mbc3band b1 threshold", UNIT_DB, -60, 0,
                       3, NULL, NULL, mbc3band_set),
    CHOICE_SETTING(F_SOUNDSETTING|F_NO_WRAP, mbc3band_settings.bands[1].ratio_down,
                   LANG_MBC3BAND_RDOWN_B1, 2,
                   "mbc3band b1 ratio down",
                   "off,2:1,4:1,6:1,10:1,limit", mbc3band_set, 6,
                   ID2P(LANG_MBC3BAND_ROFF),
                   ID2P(LANG_MBC3BAND_R2),
                   ID2P(LANG_MBC3BAND_R4),
                   ...
                   ID2P(LANG_MBC3BAND_R10),
                   ID2P(LANG_MBC3BAND_RLIMIT)),
    CHOICE_SETTING(F_SOUNDSETTING|F_NO_WRAP, mbc3band_settings.bands[1].ratio_up,
                   LANG_MBC3BAND_RUP_B1, 2,
                   "mbc3band b1 ratio up",
                   "off,0.25:1,0.5:1,0.75:1", mbc3band_set, 4,
                   ID2P(LANG_MBC3BAND_ROFF),
                   ID2P(LANG_MBC3BAND_RU25),
                   ID2P(LANG_MBC3BAND_RU50),
                   ID2P(LANG_MBC3BAND_RU75)),
    INT_SETTING_NOWRAP(F_TIME_SETTING|F_SOUNDSETTING,
                       mbc3band_settings.bands[1].attack_ms,
                       LANG_MBC3BAND_ATT_B1, 10,
                       "mbc3band b1 attack", UNIT_MS, 1, 500,
                       5, NULL, NULL, mbc3band_set),
    INT_SETTING_NOWRAP(F_TIME_SETTING|F_SOUNDSETTING,
                       mbc3band_settings.bands[1].release_ms,
                       LANG_MBC3BAND_REL_B1, 100,
                       "mbc3band b1 release", UNIT_MS, 10, 2000,
                       10, NULL, NULL, mbc3band_set),
    INT_SETTING_NOWRAP(F_SOUNDSETTING, mbc3band_settings.bands[1].wet_mix,
                       LANG_MBC3BAND_MIX_B1, 100,
                       "mbc3band b1 wet mix", UNIT_PERCENT, 0, 100,
                       5, NULL, NULL, mbc3band_set),
    /* Band 2 - High */
    INT_SETTING_NOWRAP(F_SOUNDSETTING, mbc3band_settings.bands[2].threshold,
                       LANG_MBC3BAND_THRESH_B2, -12,
                       "mbc3band b2 threshold", UNIT_DB, -60, 0,
                       3, NULL, NULL, mbc3band_set),
    CHOICE_SETTING(F_SOUNDSETTING|F_NO_WRAP, mbc3band_settings.bands[2].ratio_down,
                   LANG_MBC3BAND_RDOWN_B2, 2,
                   "mbc3band b2 ratio down",
                   "off,2:1,4:1,6:1,10:1,limit", mbc3band_set, 6,
                   ID2P(LANG_MBC3BAND_ROFF),
                   ID2P(LANG_MBC3BAND_R2),
                   ID2P(LANG_MBC3BAND_R4),
                   ...
                   ID2P(LANG_MBC3BAND_R10),
                   ID2P(LANG_MBC3BAND_RLIMIT)),
    CHOICE_SETTING(F_SOUNDSETTING|F_NO_WRAP, mbc3band_settings.bands[2].ratio_up,
                   LANG_MBC3BAND_RUP_B2, 2,
                   "mbc3band b2 ratio up",
                   "off,0.25:1,0.5:1,0.75:1", mbc3band_set, 4,
                   ID2P(LANG_MBC3BAND_ROFF),
                   ID2P(LANG_MBC3BAND_RU25),
                   ID2P(LANG_MBC3BAND_RU50),
                   ID2P(LANG_MBC3BAND_RU75)),
    INT_SETTING_NOWRAP(F_TIME_SETTING|F_SOUNDSETTING,
                       mbc3band_settings.bands[2].attack_ms,
                       LANG_MBC3BAND_ATT_B2, 10,
                       "mbc3band b2 attack", UNIT_MS, 1, 500,
                       5, NULL, NULL, mbc3band_set),
    INT_SETTING_NOWRAP(F_TIME_SETTING|F_SOUNDSETTING,
                       mbc3band_settings.bands[2].release_ms,
                       LANG_MBC3BAND_REL_B2, 100,
                       "mbc3band b2 release", UNIT_MS, 10, 2000,
                       10, NULL, NULL, mbc3band_set),
    INT_SETTING_NOWRAP(F_SOUNDSETTING, mbc3band_settings.bands[2].wet_mix,
                       LANG_MBC3BAND_MIX_B2, 100,
                       "mbc3band b2 wet mix", UNIT_PERCENT, 0, 100,
                       5, NULL, NULL, mbc3band_set),
    INT_SETTING_NOWRAP(F_SOUNDSETTING, mbc3band_settings.output_gain,
                       LANG_MBC3BAND_OUTPUT, 0,
                       "mbc3band output gain", UNIT_DB, -120, 120,
                       5, NULL, NULL, mbc3band_set),
