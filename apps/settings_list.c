...
/* 3-d enhancement effect */
    ...
    CHOICE_SETTING(F_SOUNDSETTING, channel_config, LANG_CHANNEL_CONFIGURATION,
                   0,"channels",
                   "stereo,mono,custom,mono left,mono right,karaoke,swap,delay left,delay right",
                   sound_set_channels, 9,
                   ...
                   ID2P(LANG_CHANNEL_DELAY_LEFT),ID2P(LANG_CHANNEL_DELAY_RIGHT)),
    SOUND_SETTING(F_SOUNDSETTING, stereo_width, LANG_STEREO_WIDTH,
                  "stereo_width", SOUND_STEREO_WIDTH),
    SOUND_SETTING(F_SOUNDSETTING, channel_delay, LANG_CHANNEL_DELAY,
                  "channel_delay", SOUND_CHANNEL_DELAY),
