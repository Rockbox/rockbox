...
EXPORT_SYMBOL(plugin_get_buffer);
...
EXPORT_SYMBOL(plugin_get_audio_buffer);
...
EXPORT_SYMBOL(plugin_tsr);

char *plugin_get_current_filename(void)
{
    return current_plugin;
}
EXPORT_SYMBOL(plugin_get_current_filename);
