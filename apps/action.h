...
enum {
    ...
    ACTION_USB_HID_XPINSTALL_ENTER,
    ACTION_USB_HID_XPINSTALL_F8,
    ACTION_USB_HID_XPINSTALL_LEFT,
    ACTION_USB_HID_XPINSTALL_RIGHT,
    ACTION_USB_HID_XPINSTALL_UP,
    ACTION_USB_HID_XPINSTALL_DOWN,
