            ...
            if (cramfs_in_data != NULL)
            {
                ...
                if (cramfs_new_data != NULL)
                {
                    ...
                    else
                    {
                        ...
                        emit logItem("Patch saving to disk", LOGERROR);
                        ...
                        if (cramfs_output != NULL)
                        {
                            ...
                            emit logItem(m_blfile.toStdString().c_str(), LOGINFO);
                            int encrypt_res = ypr_encrypt((char*)m_blfile.toStdString().c_str(), tempdir.path().toLatin1().data());
