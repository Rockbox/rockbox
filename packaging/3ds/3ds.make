...
APP_ICON	:= $(ROOTDIR)/packaging/3ds/res/icon.png

# CIA
BANNER_AUDIO	:= $(ROOTDIR)/packaging/3ds/res/banner.wav
BANNER_IMAGE	:= $(ROOTDIR)/packaging/3ds/res/banner.cgfx
RSF_PATH	:= $(ROOTDIR)/packaging/3ds/res/app.rsf
#LOGO		:= $(ROOTDIR)/packaging/3ds/logo.lz11
UNIQUE_ID	:= 0xCB001
