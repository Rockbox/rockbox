...
struct t_ypr_patched_md5sum
{
    char md5sum[33];    /* 32 bytes + 1 zero terminator */
};

extern const struct t_ypr_patched_md5sum SAMSUNG_YPR0_INFO;

void cyclic_xor(void* data, int datasize, void* xorkey, int xorsize);
