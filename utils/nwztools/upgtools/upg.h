...
/* Read a UPG file: return a structure on a success or NULL on error. The signature
 * can optionally be NULL if you don't want to check for it (not recommended).
