...
void gen_macro(const std::string& filename, bool variadic, char const *author)
{
...
#define REG_READ "REG_READ"
    ...
    fprintf(f, "\
#define BF_SET(reg, field)              "REG_WRITE"(##reg##_SET, BM_##reg##_##field)\n\
#define BF_CLR(reg, field)              "REG_WRITE"(##reg##_CLR, BM_##reg##_##field)\n\
#define BF_TOG(reg, field)              "REG_WRITE"(##reg##_TOG, BM_##reg##_##field)\n\
\n\
#define BF_SETV(reg, field, v)          "REG_WRITE"(##reg##_SET, BF_##reg##_##field(v))\n\
#define BF_CLRV(reg, field, v)          "REG_WRITE"(##reg##_CLR, BF_##reg##_##field(v))\n\
#define BF_TOGV(reg, field, v)          "REG_WRITE"(##reg##_TOG, BF_##reg##_##field(v))\n\
\n\
#define BF_RDX(val, reg, field)         (("REG_READ"(val) & BM_##reg##_##field) >> BP_##reg##_##field)\n\
#define BF_RD(reg, field)               BF_RDX("REG_READ"(##reg), reg, field)\n\
#define BF_WRX(val, reg, field, v)      "REG_WRITE"(val, ("REG_READ"(val) & ~BM_##reg##_##field) | (((v) << BP_##reg##_##field) & BM_##reg##_##field))\n\
#define BF_WR(reg, field, v)            BF_WRX(##reg, reg, field, v)\n\
...
\n\
#define BF_SETn(reg, n, field)          "REG_WRITE"(##reg##_SET(n), BM_##reg##_##field)\n\
#define BF_CLRn(reg, n, field)          "REG_WRITE"(##reg##_CLR(n), BM_##reg##_##field)\n\
#define BF_TOGn(reg, n, field)          "REG_WRITE"(##reg##_TOG(n), BM_##reg##_##field)\n\
\n\
#define BF_SETVn(reg, n, field, v)      "REG_WRITE"(##reg##_SET(n), BF_##reg##_##field(v))\n\
#define BF_CLRVn(reg, n, field, v)      "REG_WRITE"(##reg##_CLR(n), BF_##reg##_##field(v))\n\
#define BF_TOGVn(reg, n, field, v)      "REG_WRITE"(##reg##_TOG(n), BF_##reg##_##field(v))\n\
\n\
#define BF_RDn(reg, n, field)           BF_RDX(##reg(n), reg, field)\n\
#define BF_WRn(reg, n, field, v)        BF_WRX(##reg(n), reg, field, v)\n\
...
int main(int argc, char **argv)
{
    ...
    if(!no_macro)
    {
        ...
        gen_macro(g_macro_filename, !no_variadic, author);
