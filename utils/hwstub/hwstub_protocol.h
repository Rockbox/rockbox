 ...
 */
#define HWSTUB_ACK 0x100
#define HWSTUB_NACK 0x200

#define HWSTUB_GET_LOG  0x40
#define HWSTUB_GET_LOG_ACK 0x140
#define HWSTUB_GET_LOG_NACK 0x240
#define HWSTUB_READ     0x41
#define HWSTUB_READ2    0x42
#define HWSTUB_READ2_ACK 0x142
#define HWSTUB_READ2_NACK 0x242
#define HWSTUB_WRITE    0x43
#define HWSTUB_WRITE_ACK 0x143
#define HWSTUB_WRITE_NACK 0x243
#define HWSTUB_EXEC     0x44
#define HWSTUB_EXEC_ACK 0x144
#define HWSTUB_EXEC_NACK 0x244
#define HWSTUB_READ2_ATOMIC 0x45
#define HWSTUB_READ2_ATOMIC_ACK 0x145
#define HWSTUB_READ2_ATOMIC_NACK 0x146
#define HWSTUB_WRITE_ATOMIC 0x46
#define HWSTUB_WRITE_ATOMIC_ACK 0x146
#define HWSTUB_WRITE_ATOMIC_NACK 0x147
#define HWSTUB_GET_DESC 0x48
#define HWSTUB_GET_DESC_ACK 0x148
#define HWSTUB_GET_DESC_NACK 0x248
