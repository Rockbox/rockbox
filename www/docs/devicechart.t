...
<tr><th>&nbsp;</th>
    <th>Old Player</th>
    <th>Player/Studio</th>
    <th>Old Recorder (firmware 1.17)</th>
    <th>Recorder</th>
    <th>FM Recorder</th>
    <th>V2 Recorder</th>
</tr>
...
<tr><th><b>LCD Type</b></th>
    <td>Character 11x2 <a href=#footnote1>(1)</a></td>
...
<p>
 <a name=footnote1></a><i>(1) The old player has a limited LCD with no
   support for double line height and only four user definable characters
   instead of eight</i>
 <br>
 <a name=footnote2></a><i>(2) The early V2 models were in fact FM
