...
/* implementation NOTE: unregister callbacks are not called by timer_unregister() 
 * the unregister_callback only gets called when your timer gets overwritten by
* a lower priority timer using timer_register() */
