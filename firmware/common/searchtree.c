...
void searchtree_init(struct searchtree *tree)
{
    ...
    tree->root.list[0]  = &tree->root;
    tree->root.list[1]  = &tree->root;
    tree->root.priority = 0;
}
                                           ...
                                           struct searchtree_node **upp)
{
    ...
    struct searchtree_node *node = up->child[1];
                                                ...
                                                unsigned long key_max)
{
    ...
    struct searchtree_node *next = tree->root.child[1];
