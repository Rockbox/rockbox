...
/* see if this file has open streams and return that fileobj_desc if so,
   else grab a new one from the free list; returns true if file wasn't
   already open */
