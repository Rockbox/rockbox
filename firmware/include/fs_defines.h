...
#ifdef BOOTLOADER
#define IOC_NUM_ENTRIES     IOC_KB_BUFS(8)   /* bootloader doesn't do much */
#elif MEMORYSIZE <= 8
#define IOC_NUM_ENTRIES     IOC_KB_BUFS(16)  /* haven't attempted to determine opmtimal size */
#else
/* MEMORYSIZE > 8 */
#ifdef HAVE_DISK_STORAGE
#define IOC_NUM_ENTRIES     IOC_KB_BUFS(128) /* about right; a couple dozen too big really */
#else
#define IOC_NUM_ENTRIES     IOC_KB_BUFS(96)  /* a few extra seeks don't cause trouble here */
#endif
#endif /* MEMORYSIZE */
