 ...
 * type appear more relevant. */
#ifdef BOOTLOADER
/* bootloader doesn't do much so be minimal */
#define IOCACHE_SIZE    8
#elif MEMORYSIZE <= 2
#define IOCACHE_SIZE    56
#elif MEMORYSIZE <= 8 || !defined(HAVE_DISK_STORAGE)
#define IOCACHE_SIZE    76
#else /* MEMORYSIZE > 8 && defined(HAVE_DISK_STORAGE) */
#define IOCACHE_SIZE    128
#endif /* MEMORYSIZE */
