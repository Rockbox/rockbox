...
#   define hidedir(x,y)    app_hidedir(x,y)
...
extern int app_hide(const char* name, bool do_hide);
extern int app_hidedir(const char* name, bool do_hide);
...
#   define hidedir(x,y) sim_hidedir(x,y)
#   define filesize(x) sim_filesize(x)
#   define fsync(x) sim_fsync(x)
#   define ftruncate(x,y) sim_ftruncate(x,y)
#   define lseek(x,y,z) sim_lseek(x,y,z)
...
extern int sim_hide(const char* name, bool do_hide);
extern int sim_hidedir(const char* name, bool do_hide);
#endif
...
extern int hide(const char* name, bool do_hide);
extern int hidedir(const char* name, bool do_hide);
