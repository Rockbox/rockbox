...
void tim1_brk_irq_handler(void) ATTR_IRQ_HANDLER;
void tim1_cc_irq_handler(void) ATTR_IRQ_HANDLER;
void tim1_trg_irq_handler(void) ATTR_IRQ_HANDLER;
void tim1_up_irq_handler(void) ATTR_IRQ_HANDLER;
void tim2_irq_handler(void) ATTR_IRQ_HANDLER;
void tim3_irq_handler(void) ATTR_IRQ_HANDLER;
void tim4_irq_handler(void) ATTR_IRQ_HANDLER;
void tim6_dac_irq_handler(void) ATTR_IRQ_HANDLER;
void tim7_irq_handler(void) ATTR_IRQ_HANDLER;
void tim8_brk_tim12_irq_handler(void) ATTR_IRQ_HANDLER;
void tim8_cc_irq_handler(void) ATTR_IRQ_HANDLER;
void tim8_trg_tim14_irq_handler(void) ATTR_IRQ_HANDLER;
void tim8_up_tim13_irq_handler(void) ATTR_IRQ_HANDLER;
void tim15_irq_handler(void) ATTR_IRQ_HANDLER;
void tim16_irq_handler(void) ATTR_IRQ_HANDLER;
void tim17_irq_handler(void) ATTR_IRQ_HANDLER;
