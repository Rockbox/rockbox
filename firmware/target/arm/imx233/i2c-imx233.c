...
static imx233_dpc_id_t i2c_dpc_id; /* timeout DPC ID */

/* timeout callback */
static void imx233_i2c_timeout(struct imx233_dpc_ctx_t *ctx, intptr_t user);
...
static void imx233_i2c_start(void)
{
    ...
    if(i2c_head->tmo_ms > 0)
        i2c_dpc_id = imx233_dpc_start(false, i2c_head->tmo_ms * 1000, imx233_i2c_timeout, 0);
    else
        i2c_dpc_id = DPC_INVALID_ID;
}
...
{
    /* cancel DPC */
    if(i2c_dpc_id != DPC_INVALID_ID)
        imx233_dpc_abort(i2c_dpc_id);
