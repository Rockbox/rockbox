 ...
 * NOTE if hbus_fdiv is nonzero, hbus_idiv is ignored, if it's zero then frac div is disabled */
void imx233_clkctrl_set_cpu_hbus_div(int cpu_idiv, int cpu_fdiv, int hbus_div, int hbus_fdiv);
#endif
