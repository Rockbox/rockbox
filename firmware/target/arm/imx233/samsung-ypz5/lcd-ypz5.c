...
{
    lcdif_send_cmd_word(reg);
    lcdif_send_data_word(val);
}
...
static void setup_parameters(void)
{
    ...
    BF_WR_V(LCDIF_CTRL, DATA_SWIZZLE, NO_SWAP);

    /* timing: data setup = 2, data hold = 1, cmd setup = 1, cmd hold = 1 */
