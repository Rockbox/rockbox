...
#define VPIN_PWM(channel)   VPIN_PACK(2, 0 + (channel), MAIN)

#define VPIN_I2C_SCL        VPIN_PACK(2, 5, MAIN)
#define VPIN_I2C_SDA        VPIN_PACK(2, 6, MAIN)

#define VPIN_SSP1_DET       VPIN_PACK(1, 28, MAIN)
#define VPIN_SSP1_CMD       VPIN_PACK(1, 22, MAIN)
#define VPIN_SSP1_SCK       VPIN_PACK(1, 23, MAIN)
#define VPIN_SSP1_D0        VPIN_PACK(1, 24, MAIN)
#define VPIN_SSP1_D1        VPIN_PACK(1, 25, MAIN)
#define VPIN_SSP1_D2        VPIN_PACK(1, 26, MAIN)
#define VPIN_SSP1_D3        VPIN_PACK(1, 27, MAIN)
#define VPIN_SSP1_D4        VPIN_PACK(0, 26, ALT2)
#define VPIN_SSP1_D5        VPIN_PACK(0, 27, ALT2)
#define VPIN_SSP1_D6        VPIN_PACK(0, 28, ALT2)
#define VPIN_SSP1_D7        VPIN_PACK(0, 29, ALT2)

#define VPIN_SSP2_DET       VPIN_PACK(0, 19, ALT2)
#define VPIN_SSP2_CMD       VPIN_PACK(0, 20, ALT2)
#define VPIN_SSP2_SCK       VPIN_PACK(0, 23, ALT2)
#define VPIN_SSP2_D0        VPIN_PACK(2, 14, ALT2)
...
#define VPIN_UARTDBG_TX     VPIN_PACK(2, 1, ALT2)
#define VPIN_UARTDBG_RX     VPIN_PACK(2, 0, ALT2)
