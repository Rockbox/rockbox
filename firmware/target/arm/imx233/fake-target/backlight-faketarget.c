...
{
#warning uncomment/fix if using pwm
    /* NOTE brightness values depend on the config file in firmware/export/config/faketarget.h
    /*
...
{
#warning Implement this if there is a backlight gate, or drop otherwise
    /*
