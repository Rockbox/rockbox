...
struct imx233_i2c_xfer_t read_status_xfer; /* async transfer to read touch status */
uint8_t read_status_sel_reg; /* buffer for async transfer operation */
uint8_t read_status_buf[2]; /* buffer for async transfer operation */
