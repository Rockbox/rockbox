 ...
 * - high precision (micro-second) but small delays (20ms max)
 ...
 * accuracy is not needed, the system tick tasks are better suited.
 */

/** DPC context */
struct imx233_dpc_ctx_t;
/** DPC id (for cancelletion) */
...
/* Abort a DPC
 * Note that there is an inherit race condition between cancelling and timer
