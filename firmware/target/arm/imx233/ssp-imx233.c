...
#define TIMEOUT_IRQ RESP_TIMEOUT_IRQ, DATA_TIMEOUT_IRQ, RECV_TIMEOUT_IRQ
...
#if IMX233_SUBTARGET < 3700
#define SSP_SETn(reg, n, field) BM_##reg##_SET(field)
#define SSP_CLRn(reg, n, field) BM_##reg##CLR(field)
#define SSP_RDn(reg, n, field) BR_##reg(field)
...
#else
#define SSP_SETn(reg, n, field) BM_##reg##_SET(n, field)
#define SSP_CLRn(reg, n, field) BM_##reg##_CLR(n, field)
#define SSP_RDn(reg, n, field) BR_##reg(n, field)
