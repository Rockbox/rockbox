...
#define AS3525_SDSLOT_FREQ_SLOW  12000000
#define AS3525_SDSLOT_DIV_SLOW   (CLK_DIV(AS3525_PLLA_FREQ, AS3525_SDSLOT_FREQ_SLOW) -1)
#define AS3525_IDE_FREQ          80000000
#else
#define AS3525_IDE_FREQ          50000000    /* The OF uses 66MHz maximal freq */
#if 0
#define AS3525_IDE_FREQ_SLOW     25000000
#define AS3525_IDE_DIV_SLOW      (CLK_DIV(AS3525_PLLA_FREQ, AS3525_IDE_FREQ_SLOW) - 1)/*div=1/(n+1)*/
#endif
#endif /* CONFIG_CPU == AS3525v2 */
