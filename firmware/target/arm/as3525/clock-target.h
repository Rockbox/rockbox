...
#define AS3525_PCLK_DIV0         (CLK_DIV(AS3525_FCLK_FREQ, AS3525_DRAM_FREQ) - 1) /*div=1/(n+1)*/
...
#if LCD_DEPTH > 1
  #define AS3525_SSP_PRESCALER_SLOW ((CLK_DIV(AS3525_PCLK_FREQ, AS3525_SSP_FREQ_MIN) + 1) & ~1)  /* must be an even number */
  ...
  #define AS3525_SSP_FREQ_MIN       0 /* No set minimum we just use max divider */
#endif
