...
static struct semaphore lcd_updating;

void INT_DWDMA(void)
{
    DWDMA_CLEAR_TFR |= 1;
    semaphore_release(&lcd_updating);
}
...
void lcdctrl_init(void)
{
    ...
    memset((void*)(LCD_BUFF-8*4), 0, (2048+8)*4);
...
void lcd_init_device(void)
{
    ...
    semaphore_init(&lcd_updating, 1, 0);
}

void lcd_update()
{
    semaphore_wait(&lcd_updating, TIMEOUT_BLOCK);
