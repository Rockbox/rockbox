...
{
    sim_irq_mtx = (sysMutex *) sys_mutex_create();
    if (sim_irq_mtx == NULL)
    {
        panicf("Cannot create sim_irq_mtx\n");
        return false;
    }
