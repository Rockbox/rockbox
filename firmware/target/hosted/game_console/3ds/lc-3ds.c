...
/* reserve only the required memory for rockbox app,
   the rest will be used to load .so objects */
u32 __ctru_heap_size        = MEMORYSIZE * 1024 * 1024;
u32 __ctru_linear_heap_size = MEMORYSIZE * 1024 * 1024;
