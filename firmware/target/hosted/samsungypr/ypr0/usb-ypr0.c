...
/**
 * 
 * Start of pure gadgetfs stuff - does not contain (hopefully) rb stuff
 * 
 */

/*
 * TODO this information shall be placed either in
    1) a common place
    2) every target specifies it in its place
    3) system-target, where also NUM_ENDPOINTS is defined as well
*/
...
// TODO any threading in there does not work at all

static int sd_thread_stack[DEFAULT_STACK_SIZE*2];
