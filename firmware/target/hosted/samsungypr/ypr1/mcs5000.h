...
#define DEV_CTRL_TOUCH_I2C_READ                 _IOWR(MCS5000_IOCTL_MAGIC, MCS5000_IOCTL_TOUCH_I2C_READ, TsI2CData)
#define DEV_CTRL_TOUCH_I2C_WRITE                _IOWR(MCS5000_IOCTL_MAGIC, MCS5000_IOCTL_TOUCH_I2C_WRITE, TsI2CData)
...
} __attribute__((packed)) mcs5000_raw_data;
