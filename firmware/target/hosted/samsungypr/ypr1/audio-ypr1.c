...
void audio_set_output_source(int source)
{
    ...
    case AUDIO_SRC_FMRADIO:
        /* TODO I don't understand why not allowing equalization
         * while listening to FM radio...Moreover we don't have any
         * recording, so the following makes no sense here.
         *
