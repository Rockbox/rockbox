...
enum sys_fs_interface_id
{
    ...
    SYSFS_SCALING_GOVERNOR,
    SYSFS_POWER_STATE,
    SYSFS_POWER_WAKE_LOCK
};


typedef enum sys_fs_interface_id sys_fs_interface_id;
...
*/
bool sysfs_get_int( sys_fs_interface_id id, int* value );
...
/*
    ...
    Returns true on success, false else.
*/
bool sysfs_set_int( sys_fs_interface_id id, int value );
...
/*
    ...
    Returns true on success, false else.
*/
bool sysfs_get_char( sys_fs_interface_id id, char* value );
...
/*
    ...
    Returns true on success, false else.
*/
bool sysfs_set_char( sys_fs_interface_id id, char value );
...
/*
    ...
    Returns true on success, false else.
*/
bool sysfs_get_string( sys_fs_interface_id id, char* value, int size );
...
/*
    ...
    Returns true on success, false else.
*/
bool sysfs_set_string( sys_fs_interface_id id, char* value );
