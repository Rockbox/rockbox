...
{
    queue_post(&button_queue, SYS_JNI_CALL, (uintptr_t)pcm_play_dma_stop_);
}
...
void pcm_play_dma_pause_true(void)
{
    pcm_play_dma_pause_(true);
}

void pcm_play_dma_pause_false(void)
{
...
{
    if (pause)
        queue_post(&button_queue, SYS_JNI_CALL, (uintptr_t)pcm_play_dma_pause_true);
    else
        queue_post(&button_queue, SYS_JNI_CALL, (uintptr_t)pcm_play_dma_pause_false);
}
...
{
    queue_post(&button_queue, SYS_JNI_CALL, (uintptr_t)pcm_play_dma_init_);
}
...
void pcm_set_mixer_volume_(void)
{
...
void pcm_set_mixer_volume(int volume)
{
    ...
    queue_post(&button_queue, SYS_JNI_CALL, (uintptr_t)pcm_set_mixer_volume_);
}

/*
 * release audio resources */
void pcm_shutdown_(void)
{
    JNIEnv e = *env_ptr;
...
{
    queue_post(&button_queue, SYS_JNI_CALL, (uintptr_t)pcm_shutdown_);
}
