...
void system_init(void)
{
 ...
 //    setenv("RBROOT", "/sdcard/rockbox", 1);
...
/* here would be the correct place for muteopen (headphone-out relay) but in pcm-dx50.c, pcm_play_dma_start() 
