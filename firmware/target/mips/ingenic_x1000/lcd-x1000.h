...
#define LCD_INSTR_CMD       0   /* Send command */
#define LCD_INSTR_DAT       1   /* Send data */
#define LCD_INSTR_UDELAY    2   /* udelay() for specified time */
#define LCD_INSTR_END       3   /* Indicates end of instruction stream */
