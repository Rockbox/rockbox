...
#define INSTALL_ERR_FLASH(x,y)          (-10000 + (INSTALL_ERR_##x)*100 + (y))
...
/* Returns human readable error message for the error code 'rc'.
 * The provided 'buf' is sometimes needed to format the message string. */
extern const char* install_strerror(int rc, char* buf, size_t bufsize);
