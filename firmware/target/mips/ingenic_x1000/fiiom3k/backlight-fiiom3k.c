...
static int backlight_calc_duty(int period, int brightness)
{
    return period * brightness / MAX_BRIGHTNESS_SETTING;
}
...
{
    int duty_ns = backlight_calc_duty(BL_LCD_PERIOD, brightness);
...
{
    int duty_ns = backlight_calc_duty(BL_BTN_PERIOD, brightness);
