...
void spl_main(void)
{
    ...
    // DEBUG: dram corruption test!
//     memset((void*)0xa0000000, 0, 1024 * 1024);
//     return;
    
    // DEBUG: check addressing is sane
//     uint32_t* ptr = (uint32_t*)0xa0000000;
//     uint32_t count = (32 * 1024 * 1024 / 4) / (1 << 2);
//     for(uint32_t i = 0; i < count; i = i + 1)
//         *ptr++ = i;
//     return;
    
//     memset((void*)0xa0000000, 0, 1024*1024);
//     uint32_t* ptr_1 = (uint32_t*)0xa0000000;
//     uint32_t* ptr_2 = (uint32_t*)0xa0000400;
// //     *ptr_2 = 0xbb;
// 	*ptr_1 = 0xaa;
// 	*ptr_2 = 0xbb;
//     return;
