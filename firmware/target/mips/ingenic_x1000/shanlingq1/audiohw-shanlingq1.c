...
void audiohw_init(void)
{
    ...
    es9218_set_amp_mode(ES9218_AMP_MODE_2VRMS);

    /* TODO: figure out how to control the DAC's analog stage properly
     *
     * the datasheet doesn't contain much information on this subject,
     * it appears that the DAC may need a hard or soft reset in order
     * to switch between 1Vrms and 2Vrms modes.
     */
}
