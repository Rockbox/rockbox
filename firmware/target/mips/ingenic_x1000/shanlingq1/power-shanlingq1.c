 ...
 *
 * the CW2015 is a dedicated chip which measures the battery state of charge,
 * hopefully it can give a more accurate reading than voltage. Mainline Linux
 * has a driver for it; unfortunately it's more than just "read data over I2C"
 *
 * For now just use a ripped off battery curve from the M3K since the Q1 has
 * the same size battery. Report voltage using the AXP driver.
 */
