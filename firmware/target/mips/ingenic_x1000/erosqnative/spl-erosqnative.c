...
// TODO: Figure out this cmdline stuff for dual-boot
static const char normal_cmdline[] = "mem=32M@0x0\
 no_console_suspend\
...
static const char recovery_cmdline[] = "mem=32M@0x0\
 no_console_suspend\
 console=ttyS2,115200n8\
 lpj=5009408\
 ip=off";
...
{
    const uint32_t pinmask = (1 << 16) | (1 << 17);
