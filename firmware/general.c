                               ...
                               int numberlen IF_CNFN_NUM_(, int *num))
{
    ...
    snprintf(buffer + pathlen, MAX_PATH - pathlen, "ss-puzzles-%dx%dx%d%s",
             LCD_WIDTH, LCD_HEIGHT, LCD_DEPTH, suffix);
                               ...
                               bool unique_time)
{
    ...
    snprintf(buffer + pathlen, MAX_PATH - pathlen,
             "/ss-puzzles-%dx%dx%d%s", LCD_WIDTH, LCD_HEIGHT, LCD_DEPTH, suffix);
