...
void sys_poweroff(void); /* special case of sys_shutdown with action=SHUTDOWN_POWEROFF */
...
enum shutdown_action
{
    ...
    SHUTDOWN_SUSPEND, /* Suspend the system */
#endif
#if (CONFIG_SHUTDOWN & SHUTDOWN_CFG_RET_TO_BL)
    SHUTDOWN_RET_TO_BL, /* Return to bootloader */
#endif
};
/* Shutdown parameters */
struct shutdown_param
{
    ...
    struct
    {
        /* Buffer to ROLO: this is the raw code and checksum checks must be done
