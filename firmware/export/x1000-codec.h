...
extern void x1000_icodec_set_dac_frequency(int fsel);
extern void x1000_icodec_set_adc_frequency(int fsel);
extern void x1000_icodec_set_adc_highpass_filter(bool en);
