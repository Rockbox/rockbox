...
#ifndef __BLUETOOTH_HCI_H
#define __BLUETOOTH_HCI_H
...
typedef struct {
    unsigned char     lap[3];
    unsigned char     length;     /* 1.28s units */
...
typedef struct {
    unsigned short    max_period; /* 1.28s units */
    unsigned short    min_period; /* 1.28s units */
    unsigned char     lap[3];
    unsigned char     length;     /* 1.28s units */
    unsigned char     num_rsp;
...
typedef struct {
    unsigned short    handle;
    unsigned int    tx_bandwith;
    unsigned int    rx_bandwith;
    unsigned short    max_latency;
    unsigned short    voice_setting;
    unsigned char     retrans_effort;
    unsigned short    pkt_type;
...
typedef struct {
    unsigned char     service_type;       /* 1 = best effort */
    unsigned int    token_rate;     /* Byte per seconds */
    unsigned int    peak_bandwidth;     /* Byte per seconds */
    unsigned int    latency;        /* Microseconds */
    unsigned int    delay_variation;    /* Microseconds */
...
typedef struct {
    unsigned short    handle;
    unsigned short    max_latency;
    unsigned short    min_remote_timeout;
    unsigned short    min_local_timeout;
...
typedef struct {
    unsigned char     status;
    unsigned char     num_current_iac;
    unsigned char     lap[MAX_IAC_LAP][3];
...
typedef struct {
    ...
    char    bdaddr[6];
    unsigned char     link_type;
    unsigned char     trans_interval;
    unsigned char     retrans_window;
    unsigned short    rx_pkt_len;
    unsigned short    tx_pkt_len;
    unsigned char     air_mode;
...
typedef struct {
    unsigned char     status;
    unsigned short    handle;
    unsigned short    max_tx_latency;
    unsigned short    max_rx_latency;
    unsigned short    min_remote_timeout;
    unsigned short    min_local_timeout;
...
#define acl_handle_pack(h, f)   (unsigned short)((h & 0x0fff)|(f << 12))
