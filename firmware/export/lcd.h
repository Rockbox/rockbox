...
#ifndef LCD_NBELEMS
#if defined(LCD_STRIDEFORMAT) && LCD_STRIDEFORMAT == VERTICAL_STRIDE
#define LCD_NBELEMS(w, h) (((w*STRIDE_MAIN(w, h)) + h) / sizeof(fb_data))
#else
#define LCD_NBELEMS(w, h) (((h*STRIDE_MAIN(w, h)) + w) / sizeof(fb_data))
#endif
