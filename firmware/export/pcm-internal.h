...
#define PCM_FACTOR_MIN        0x00000000 /* Minimum final factor */
#define PCM_FACTOR_MAX        0x00010000 /* Maximum final factor */
#define PCM_FACTOR_UNITY      (1 << PCM_SW_VOLUME_FRACBITS)
#elif PCM_SW_VOLUME_FRACBITS <= 30
#define PCM_FACTOR_MIN        0x00000000
#define PCM_FACTOR_MAX        0x7fffffff
#define PCM_FACTOR_UNITY      (1 << PCM_SW_VOLUME_FRACBITS)
#elif PCM_SW_VOLUME_FRACBITS == 31 /* s0.31 (can't do +0x80000000) */
#define PCM_FACTOR_MIN        0x00000000
#define PCM_FACTOR_MAX        0x7fffffff
#define PCM_FACTOR_UNITY      0x7fffffff
