...
/* RMI sleep mode */
/* the register's value structure for power management is:
report rate + sleep mode
-  with report rate 0x40 or 0x80 (0x80 is default)
- with sleep modes code 0 to 4, 1 is default */
#define RMI_REPORT_RATE_NORMAL           0x80
#define RMI_REPORT_RATE_LOW              0x40
#define RMI_SLEEP_MODE_FORCE_FULLY_AWARE 0x00
