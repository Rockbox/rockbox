...
/* notify the USB code that some important even has occured which influences the
...
/* when the target has several drivers, decide whether mass storage should
 * skip the first drive. This is useful when the second driver is a SD card
 * can the host only supports access to the first USB drive (this is very common
