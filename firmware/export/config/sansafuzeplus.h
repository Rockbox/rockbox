...
#define HAVE_TOUCHPAD_SENSITIVITY_SETTING_ANALOG
#define DEFAULT_SENSITIVITY_SETTING  10
#define MIN_SENSITIVITY_SETTING      -10
#define MAX_SENSITIVITY_SETTING      24
