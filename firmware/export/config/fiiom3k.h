...
#define USB_DW_TURNAROUND 5 // FIXME
/* #define USB_READ_BUFFER_SIZE (1024 * 32) */
/* #define USB_WRITE_BUFFER_SIZE (1024 * 32) */
#define HAVE_USBSTACK
#define USB_VENDOR_ID 0xa108 // FIXME
#define USB_PRODUCT_ID 0x1000 // FIXME
