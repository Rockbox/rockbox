...
#define LCD_DEPTH  16 /* would be nice to do 18, or 24 if display supports it */
#define LCD_PIXELFORMAT  RGB565 /* rgb565 for 16 bit, rgb888 for 18 bit? */
...
#define HAVE_PCM5102A
#define HAVE_SW_TONE_CONTROLS
#define HAVE_SW_VOLUME_CONTROL

/* this was the (partial) fix for low-volume popping issues? */
