...
#if defined(HAVE_SDL_AUDIO) && CONFIG_CODEC == SWCODEC \
    && (!(CONFIG_PLATFORM & PLATFORM_MAEMO5) || defined(SIMULATOR)) \
...
/* 24 bits is a nice res for ~ -128dB...+36dB that covers all targets */
