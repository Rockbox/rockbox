...
struct __attribute__((packed,aligned(4))) usb_dw_config
{
    volatile struct usb_dw_core_regs* core;
...
extern void usb_dw_irq();
extern void usb_dw_target_enable_clocks();
extern void usb_dw_target_disable_clocks();
extern void usb_dw_target_enable_irq();
extern void usb_dw_target_disable_irq();
extern void usb_dw_target_clear_irq();
