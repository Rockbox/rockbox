...
/* MRSW access policy (could become a setting in mrsw_init()) */
#define MRSW_POL_WRT  0 /* Grants preferential access to writers, blocks
                           further readers if any writers are waiting */
#define MRSW_POL_RR   1 /* Grants access to threads in round-robin fashion;
                           single writers or runs of readers */

#ifdef HAVE_PRIORITY_SCHEDULING
#define MRSW_ACC_POL MRSW_POL_WRT
#else
#define MRSW_ACC_POL MRSW_POL_WRT /* Right now, didn't bother with RR */
#endif
...
struct mrsw_lock
{
    ...
    struct thread_entry *reader0;
    struct thread_entry *writer0;
#endif
