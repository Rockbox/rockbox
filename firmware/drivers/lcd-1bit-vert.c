...
/*** globals ***/
// fb_remote_data lcd_remote_stattic_framebuffer[][]
// fb_remote_data *lcd_remote_framebuffer = &lcd_remote_static_framebuffer[][]
...
void LCDFN(clear_display)(void)
{
    ...
    memset(LCDFN(framebuffer), bits, sizeof LCDFN(static_framebuffer));
