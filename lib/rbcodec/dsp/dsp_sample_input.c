...
static void INIT_ATTR dsp_sample_io_init(struct sample_io_data *this,
                                         enum dsp_ids dsp_id)
{
    this->output_frequency = DSP_OUT_DEFAULT_HZ;
                             ...
                             intptr_t *value_p)
{
    ...
    case DSP_RESET:
        ...
        this->format.frequency = this->output_frequency;
        this->format.codec_frequency = this->output_frequency;
    ...
    case DSP_SET_FREQUENCY:
        format_change_set(this);
        value = value > 0 ? value : this->output_frequency;
    ...
    case DSP_SET_OUT_FREQUENCY:
        ...
        this->output_frequency = value;
        *value_p = value;
        break;

    case DSP_GET_OUT_FREQUENCY:
        *value_p = this->output_frequency;
