                                         ...
                                         struct dsp_buffer **buf_p)
{
    ...
    crossfeed_flush(this); /* Going online or type change */
    ...
    {
        state->coef1 = (0x7fffffff / NATIVE_FREQUENCY) * 2128; /* 1 / (F.Rforward.C) */
        state->coef2 = (0x7fffffff / NATIVE_FREQUENCY) * 1000; /* 1 / (F.Rcross.C) */
        this->process[0] = crossfeed_meier_process;
    }
