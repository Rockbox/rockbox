...
/* DSP message hook */
static void crossfeed_configure(struct dsp_proc_entry *this,
...
/* Database entry */
const struct dsp_proc_db_entry crossfeed_proc_db_entry =
{
    .id = DSP_PROC_CROSSFEED,
    .configure = crossfeed_configure,
};
