...
static void pbe_buffer_alloc(void)
{
    ...
    for (int i = 0; i < 6; i++)
    {
        hid = core_alloc(str[i],sizeof(int32_t) * len[i]);
        switch(i)
        { 
        case 0:
            b0[0] = core_get_data(hid);
            break;
        case 1:
            b0[1] = core_get_data(hid);
            break;
        case 2:
            b2[0] = core_get_data(hid);
            break;
        case 3:
            b2[1] = core_get_data(hid);
            break;
        case 4:
            b3[0] = core_get_data(hid);
            break;
        case 5:
            b3[1] = core_get_data(hid);
            break;
        }  
    }
