...
static void lin_resample_configure(struct dsp_proc_entry *this,
                                   ...
                                   intptr_t value)
{
    ...
    case DSP_PROC_CLOSE:
        DEBUGF("Error: Closing DSP_PROC_RESAMPLE!\n");
        break;
...
const struct dsp_proc_db_entry resample_proc_db_entry =
{
    .id = DSP_PROC_RESAMPLE,
    .configure = lin_resample_configure
};
