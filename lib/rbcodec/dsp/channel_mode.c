...
static void channel_mode_configure(struct dsp_proc_entry *this,
                                   struct dsp_config *dsp,
...
const struct dsp_proc_db_entry channel_mode_proc_db_entry =
{
    .id = DSP_PROC_CHANNEL_MODE,
    .configure = channel_mode_configure
};
