...
CODECS_SRC := $(call preprocess, $(RBCODEC_DIR)/codecs/SOURCES)
OTHER_SRC += $(CODECS_SRC)

CODECS := $(CODECS_SRC:.c=.codec)
CODECS := $(subst $(RBCODEC_DIR),$(RBCODEC_BLD),$(CODECS))

# TLSF memory allocator library
include $(RBCODEC_DIR)/codecs/lib/tlsf/libtlsf.make

# the codec helper library
include $(RBCODEC_DIR)/codecs/lib/libcodec.make
OTHER_INC += -I$(RBCODEC_DIR)/codecs/lib

# the codec libraries
include $(RBCODEC_DIR)/codecs/demac/libdemac.make
include $(RBCODEC_DIR)/codecs/liba52/liba52.make
include $(RBCODEC_DIR)/codecs/libalac/libalac.make
include $(RBCODEC_DIR)/codecs/libasap/libasap.make
include $(RBCODEC_DIR)/codecs/libasf/libasf.make
include $(RBCODEC_DIR)/codecs/libfaad/libfaad.make
include $(RBCODEC_DIR)/codecs/libffmpegFLAC/libffmpegFLAC.make
include $(RBCODEC_DIR)/codecs/libm4a/libm4a.make
include $(RBCODEC_DIR)/codecs/libmad/libmad.make
include $(RBCODEC_DIR)/codecs/libmusepack/libmusepack.make
include $(RBCODEC_DIR)/codecs/libspc/libspc.make
include $(RBCODEC_DIR)/codecs/libspeex/libspeex.make
include $(RBCODEC_DIR)/codecs/libtremor/libtremor.make
include $(RBCODEC_DIR)/codecs/libwavpack/libwavpack.make
include $(RBCODEC_DIR)/codecs/libwma/libwma.make
include $(RBCODEC_DIR)/codecs/libwmapro/libwmapro.make
include $(RBCODEC_DIR)/codecs/libcook/libcook.make
include $(RBCODEC_DIR)/codecs/librm/librm.make
include $(RBCODEC_DIR)/codecs/libatrac/libatrac.make
include $(RBCODEC_DIR)/codecs/libpcm/libpcm.make
include $(RBCODEC_DIR)/codecs/libtta/libtta.make
include $(RBCODEC_DIR)/codecs/libgme/libay.make
include $(RBCODEC_DIR)/codecs/libgme/libgbs.make
include $(RBCODEC_DIR)/codecs/libgme/libhes.make
include $(RBCODEC_DIR)/codecs/libgme/libnsf.make
include $(RBCODEC_DIR)/codecs/libgme/libsgc.make
include $(RBCODEC_DIR)/codecs/libgme/libvgm.make
include $(RBCODEC_DIR)/codecs/libgme/libkss.make
include $(RBCODEC_DIR)/codecs/libgme/libemu2413.make

# compile flags for codecs
CODECFLAGS = $(CFLAGS) $(RBCODEC_CFLAGS) -fstrict-aliasing \
			 -I$(RBCODEC_DIR)/codecs -I$(RBCODEC_DIR)/codecs/lib -DCODEC
...
$(CODECDIR)/%.o: $(RBCODEC_DIR)/codecs/%.c
	$(SILENT)mkdir -p $(dir $@)
	$(call PRINTS,CC $(subst $(ROOTDIR)/,,$<))$(CC) \
		-I$(dir $<) $(CODECFLAGS) -c $< -o $@

# pattern rule for compiling codecs
$(CODECDIR)/%.o: $(RBCODEC_DIR)/codecs/%.S
	$(SILENT)mkdir -p $(dir $@)
	$(call PRINTS,CC $(subst $(ROOTDIR)/,,$<))$(CC) \
