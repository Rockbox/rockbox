...
static const struct tag_info legal_tags[] = 
{
    ...
    { SKIN_TOKEN_FILE_BITRATE,          "Fb", "", NEXT_TRACK | SKIN_REFRESH_STATIC },
    { SKIN_TOKEN_FILE_CODEC,            "Fc", "", NEXT_TRACK | SKIN_REFRESH_STATIC },
    { SKIN_TOKEN_FILE_FREQUENCY,        "Ff", "", NEXT_TRACK | SKIN_REFRESH_STATIC },
    { SKIN_TOKEN_FILE_FREQUENCY_KHZ,    "Fk", "", NEXT_TRACK | SKIN_REFRESH_STATIC },
    { SKIN_TOKEN_FILE_NAME_WITH_EXTENSION,  "Fm", "", NEXT_TRACK | SKIN_REFRESH_STATIC },
    { SKIN_TOKEN_FILE_NAME,             "Fn", "", NEXT_TRACK | SKIN_REFRESH_STATIC },
    { SKIN_TOKEN_FILE_PATH,             "Fp", "", NEXT_TRACK | SKIN_REFRESH_STATIC },
    { SKIN_TOKEN_FILE_SIZE,             "Fs", "", NEXT_TRACK | SKIN_REFRESH_STATIC },
    { SKIN_TOKEN_FILE_VBR,              "Fv", "", NEXT_TRACK | SKIN_REFRESH_STATIC },
    { SKIN_TOKEN_FILE_DIRECTORY,        "D"  , "I", NEXT_TRACK | SKIN_REFRESH_STATIC },
    ...
    { SKIN_TOKEN_METADATA_ARTIST,       "Ia", "", NEXT_TRACK | SKIN_REFRESH_STATIC },
    { SKIN_TOKEN_METADATA_COMPOSER,     "Ic", "", NEXT_TRACK | SKIN_REFRESH_STATIC },
    { SKIN_TOKEN_METADATA_ALBUM,        "Id", "", NEXT_TRACK | SKIN_REFRESH_STATIC },
    { SKIN_TOKEN_METADATA_ALBUM_ARTIST, "IA", "", NEXT_TRACK | SKIN_REFRESH_STATIC },
    { SKIN_TOKEN_METADATA_GROUPING,     "IG", "", NEXT_TRACK | SKIN_REFRESH_STATIC },
    { SKIN_TOKEN_METADATA_GENRE,        "Ig", "", NEXT_TRACK | SKIN_REFRESH_STATIC },
    { SKIN_TOKEN_METADATA_DISC_NUMBER,  "Ik", "", NEXT_TRACK | SKIN_REFRESH_STATIC },
    { SKIN_TOKEN_METADATA_TRACK_NUMBER, "In", "", NEXT_TRACK | SKIN_REFRESH_STATIC },
    { SKIN_TOKEN_METADATA_TRACK_TITLE,  "It", "", NEXT_TRACK | SKIN_REFRESH_STATIC },
    { SKIN_TOKEN_METADATA_VERSION,      "Iv", "", NEXT_TRACK | SKIN_REFRESH_STATIC },
    { SKIN_TOKEN_METADATA_YEAR,         "Iy", "", NEXT_TRACK | SKIN_REFRESH_STATIC },
    { SKIN_TOKEN_METADATA_COMMENT,      "IC", "", NEXT_TRACK | SKIN_REFRESH_STATIC },
