...
/* Cache all parameters, because parameters are stored on single erase block */
static union
{
    parameter_t entry[PARAMETERS_NUM];
    /* raw consists of parameter_t array and graphics */
...
void parameters_erase(void)
{
     ...
     * timeout here because we have to wait until the erase finises as most
     * of the bootloader code executes from flash.
     */
    do
    {
