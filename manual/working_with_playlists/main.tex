...
If the dynamic playlist has finished playing, the \setting{Insert} and
\setting{Queue} functions as described in \ref{ref:playlist_submenu} will
\emph{replace} it with the selected tracks instead of adding to it.
...
\item [Insert.] Add track(s) immediately after any tracks added via the most
  ...
  playing track. If the dynamic playlist has finished playing,
  it will be \emph{replaced} with the selected track(s).
