...
the current dynamic playlist. If you instead want to look at a playlist's
content, access the \setting{Context Menu} (see
...
It can be used like the \setting{File Browser} but will automatically display 
