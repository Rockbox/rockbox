...
Once you've finished playing a dynamic playlist, the \setting{Insert} and 
\setting{Queue} functions as described in \ref{ref:playlist_submenu} will 
replace the playlist instead of adding to it.
...
\item [Insert.] Add track(s) immediately after any tracks added via the most
  ...
  it will be \emph{replaced} with the selected tracks.
