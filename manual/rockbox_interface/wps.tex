...
\begin{table}
  \begin{btnmap}{}{}
      ...
      & Goes to beginning of track, or if pressed while in the
        first seconds of a track, goes to previous track.\\
      %
      \ActionWpsSeekBack
      ...
      \opt{RECORDER_PAD,IRIVER_H100_PAD,IRIVER_H300_PAD,IRIVER_H10_PAD,MROBE100_PAD%
        ...
        \opt{HAVEREMOTEKEYMAP}{& \ActionRCWpsPitchScreen}
         & Shows \setting{Pitch Screen} (see \reference{sec:pitchscreen}).\\%
      }%
      ...
      & Skips to the previous directory.\\
      %
...
\opt{pitchscreen}{
  ...
  \nopt{swcodec}{
    \begin{table}
      \begin{btnmap}{}{}
        \ActionPsToggleMode
        & Toggles pitch changing mode \\
        %
        \ActionPsIncSmall{} / \ActionPsDecSmall
        & Increases / Decreases pitch by 0.1\% (in procentual mode) or by 0.1
          semitone (in semitone mode)\\
        %
        \ActionPsIncBig{} / \ActionPsDecBig
        & Increases / Decreases pitch by 1\% (in procentual mode) or a semitone
          (in semitone mode)\\
        %
        \ActionPsNudgeLeft{} / \ActionPsNudgeRight
        & Temporarily changes pitch by 2\% (beatmatch) \\
        %
        \ActionPsReset
        & Resets rate to 100\% \\
        %
        \ActionPsExit
        & Leaves the Pitch Screen \\
        %
      \end{btnmap}
    \end{table}
  ...
  \opt{swcodec}{
    \begin{table}
      \begin{btnmap}{}{}
        ...
        & Toggles pitch changing mode (cycles through all available modes)\\
        %
        \ActionPsIncSmall{} / \ActionPsDecSmall
        \opt{HAVEREMOTEKEYMAP}{& \ActionRCPsIncSmall{} / \ActionRCPsDecSmall}
        & Increases / Decreases pitch by 0.1\% (in procentual mode) or 0.1
          semitone (in semitone mode)\\
        %
        \ActionPsIncBig{} / \ActionPsDecBig
        ...
        & Temporarily changes pitch by 2\% (beatmatch), or modify speed (in timestretch mode) \\
        %
        \ActionPsReset
        \opt{HAVEREMOTEKEYMAP}{& \ActionRCPsReset}
        & Resets pitch and speed to 100\% \\
        %
        \ActionPsExit
