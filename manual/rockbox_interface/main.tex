...
\opt{player}{
 ...
 \opt{x5}{
    \ifpdfoutput{
    \includegraphics[height=8cm]{rockbox_interface/images/x5-front.pdf}
    }
    {\includegraphics{rockbox_interface/images/x5-front.png}}
 }
\opt{h10}{
    \ifpdfoutput{
    \includegraphics[height=8cm]{rockbox_interface/images/h10-front.pdf}
    }
    {\includegraphics{rockbox_interface/images/h10-front.png}}
 }
\opt{h10_5gb}{
    \ifpdfoutput{
    \includegraphics[height=8cm]{rockbox_interface/images/h10_5gb-front.pdf}
    }
    {\includegraphics{rockbox_interface/images/h10_5gb-front.png}}
 }
\end{center}
