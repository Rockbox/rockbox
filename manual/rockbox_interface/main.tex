...
,SANSA_C200_PAD,IAUDIO_X5_PAD,IAUDIO_M5_PAD}{%
  holding down \opt{PLAYER_PAD}{\ButtonStop}\opt{RECORDER_PAD,ONDIO_PAD}
  {\ButtonOff}\opt{GIGABEAT_PAD}{the battery switch}\opt{IPOD_4G_PAD}
  {\ButtonMenu + \ButtonSelect}\opt{SANSA_E200_PAD,SANSA_C200_PAD,IAUDIO_X5_PAD%
  ,IAUDIO_M5_PAD}{\ButtonPower} until the \dap{} shuts off.
}%
\opt{IRIVER_H100_PAD,IRIVER_H300_PAD,IAUDIO_M3_PAD}{%
