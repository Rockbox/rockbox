  ...
  \begin{table}
    \begin{btnmap}{}{}
      \ActionKbdUp/\ActionKbdDown 
        \opt{HAVEREMOTEKEYMAP}{& }
        & Moves about the virtual keyboard.
...
\opt{ondio}{
    ...
    \begin{btnmap}{Picker area}{}
      ...
      \ButtonOff 
       & Quits the virtual keyboard without saving the changes.\\
    \end{btnmap}
  \end{table}
  \begin{table}
    \begin{btnmap}{Line edit mode}{}
      \ButtonLeft/\ButtonRight & Moves left and right\\
