...
\item [\label{ref:StartFileBrowserHere}Start File Browser Here.]
  ...
  \note{If you have \setting{Auto-Change Directory} enabled, the directories
  returned will be constrained to the directory you have chosen here and those
  below it. See \reference{ref:AutoChangeDirectory}}
