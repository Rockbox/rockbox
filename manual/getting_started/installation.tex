...
\opt{sansaAMS,fuzeplus,creativezenxfi3}{
\begin{description}  
...
\opt{ipod1g2g}{
  ...
  \opt{sansa,e200v2,clipv1,clipv2,fuzeplus,c200v2,creativezenxfi3}{
...
\opt{fuzeplus,creativezenxfi3}{
  ...
  \opt{fuzeplus}{\wikilink{SansaFuzePlusPort}}%
  \opt{creativezenxfi3}{\wikilink{CreativeZENXFi3Port}}.
...
\item Connect your \dap{} to the computer via USB 
  \opt{sansa,sansaAMS,iriverh10,iriverh10_5gb,vibe500,fuzeplus,samsungyh,creativezenxfi3}
  { in MSC mode }
...
\item Take the \fname{.zip} file that you downloaded and use
 ...
 the files onto
 \opt{gigabeats,fuzeplus,creativezenxfi3}{the main data partition of}%
...
\opt{iriverh100,iriverh300,fuzeplus,creativezenxfi3}{\note{Rockbox Utility cannot uninstall the bootloader due to
