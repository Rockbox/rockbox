...
\item[Release.] The release version is the latest stable release, free
  ...
  \opt{SWCODEC}{
    \note{The current release is only available for Archos jukeboxes, recorders
      ...
      there is a stable release for \playername{}, use a current build or daily
      build.
    }
  }
...
\item[Daily Build.] In addition to the release version and the current build,
  ...
  download the daily builds from \url{http://www.rockbox.org/daily.shtml}.
