...
\begin{enumerate}
  ...
  \item Connect your \archosplayertype{} to the computer.
  \item Rename the original \fname{pp5020.mi4} file to \fname{OF.mi4} in the \fname{System} directory on your \archosplayertype{}.
    \warn{You should keep a safe backup of this file for use if you ever wish to switch back to the \archosplayerman{} firmware.}
