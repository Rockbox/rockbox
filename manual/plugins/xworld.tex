...
must run, jump, use a pistol, while teaming up with an unlikely ally, when both
become fugitives on another world.  This game plugin requires the data files,
bank* and memlist.bin, from the orginal "Another World" PC game to be copied into
the .rockbox/xworld/ directory.
