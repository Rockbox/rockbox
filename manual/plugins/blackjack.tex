...
\begin{table}
    ...
    \opt{IPOD_4G_PAD,IPOD_3G_PAD,IAUDIO_X5_PAD,GIGABEAT_PAD%
        ,SANSA_E200_PAD,SANSA_C200_PAD,MROBE100_PAD}{\ButtonSelect}
    ...
    \opt{ONDIO_PAD,IAUDIO_X5_PAD,SANSA_C200_PAD,SANSA_E200_PAD}{\ButtonDown}
    ...
    \opt{COWON_D2_PAD}{\TouchCenter}
       \opt{HAVEREMOTEKEYMAP}{& }
        & Return to menu without end the game\\
    ...
    \opt{GIGABEAT_S_PAD}{\ButtonBack}
       \opt{HAVEREMOTEKEYMAP}{& }
        & End game and return to menu / Cancel\\
    \end{btnmap}
\end{table}
