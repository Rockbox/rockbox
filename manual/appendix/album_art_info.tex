...
By default, embedded art (JPEG images in ID3v2 or MP4 tags only) is preferred over any file-based art, but this can be changed with \setting{Prefer embedded album art}.
