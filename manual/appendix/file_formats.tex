...
\includegraphics[width=0.37cm]{appendix/images/icon-rolo.png} 
  & Rockbox firmware & 
    \opt{archosplayer}{\fname{.mod}}\opt{archosrecorder,archosrecorderv2fm,archosondiofm,archosondiosp}{\fname{.ajz}}%
    \opt{iriverh100,iriverh300}{\fname{.iriver}}\opt{ipod}{\fname{.ipod}}\opt{iaudio}{\fname{.iaudio}}%
    \opt{iriverh10,iriverh10_5gb,sansa}{\fname{.mi4}}\opt{gigabeat}{\fname{.gigabeat}}%
...
\opt{swcodec}{
  ...
  {\textbf{Format} & \textbf{Extension} & \textbf{Notes}}{}{}
    ...
    \opt{iriverh100,iriverh300,iaudiox5,iaudiom5,iaudiom3}{
    ...
    \opt{gigabeats}{
      ...
      fast enough to be useful.}
    \opt{ipod,iriverh10,iriverh10_5gb,mrobe100,sansa}{
