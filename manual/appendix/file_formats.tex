...
\opt{swcodec}{
  ...
  \textbf{Format} & \textbf{Extension} & \textbf{Notes} \\\midrule
    ...
    \opt{h1xx,h300,x5,m5,m3}{
      Monkey's Audio & \fname{.ape, .mac} & -c1000 and -c2000 decodes fast enough to be useful. \\
    }
    \opt{gigabeat}{
      Monkey's Audio & \fname{.ape, .mac} & -c1000 to -c3000 decodes fast enough to be useful. \\
    }
    \\
    \midrule
    \emph{Other codecs} \\
