...
\item[Running Time:]
  ...
  \begin{description}
    \item[Running Time:]
        ...
        either disconnected it from charging (in Rockbox) or since you manually 
        resetted this item. Manual reset is done through pressing any button, 
        followed by pressing \ButtonSelect{}.
    \item[Top Time:]
        This item shows the cumulative overall runtime of your \dap{} since you 
        last manually resetted this item. Manual reset is done through pressing 
