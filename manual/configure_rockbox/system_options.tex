...
\nopt{hold_button}{
  \subsection{Advanced Key Lock}
    ...
    blocked by the key lock (software hold switch).
        ...
        \item[Autolock Delay.]
        The amount of extra delay, in Seconds, that the autolock will wait after the screen
        backlight turns off before locking. Requires Autolock On to be enabled.
