  ...
  \subsection{Advanced Key Lock}
    ...
    blocked by the key lock (software hold switch).
        ...
        Allows to select actions that will \emph{not} be blocked by the key lock.
                ...
                \item[Disable Notify.]
                Suppresses the notification 'Buttons Locked' (still will if power button is pressed).
                \note{This is a pre-requisite for \reference{ref:selective_backlight} to work also during key lock.}
