...
\subsection{Long Button Press Duration}
This option determines the time a button must be held down before it is
considered to be a long press. The default is 30/100ths of a second, but users
with limted dexterity may wish to adjust this as needed.
