...
\nopt{sansa}%will probably be there on Sansas one day -  exclude it the simple way without specific option
{
  ...
  \begin{description}
    \item [Battery Capacity: ]This setting can be used to tell Rockbox what
      ...
      \opt{archosplayer,archosrecorder}{1500mAh}%
      \opt{archosrecorderv2fm}{2200mAh}%
      \opt{archosondiosp,archosondiofm}{1000mAh}%
      \opt{iriverh100,iriverh300}{1300mAh}%
      \opt{ipodmini1g}{400mAh (1G) or 630mAh (2G)}%
      \opt{ipodcolor}{700mAh}%
      \opt{ipodnano1g}{300mAh}%
      \opt{ipodvideo}{400mAh (30GB) or 600mAh (60/80GB)}%
      \opt{ipod4g}{630mAh}%
      \opt{ipod3g}{630mAh}%
      \opt{ipod1g2g}{1200mAh}%
      \opt{iaudiom5,iaudiox5}{950mAh}%
      \opt{gigabeatfx}{2000mAh}%
      ...
      \opt{iaudio}{Rockbox does not automatically distinguish between the
        ...
        value. If your dap{} is an \opt{iaudiom5}{M5L}\opt{iaudiox5}{X5L} set the value
        to 2250mAh for more accuracy in the runtime estimation.}
      \opt{ipod,sansa}{This value is fairly meaningless in the \archosplayerman{}
