...
\opt{SANSA_FUZEPLUS_PAD,GIGABEAT_PAD}{
  \subsection{Touchpad}
    ...
    \opt{SANSA_FUZEPLUS_PAD,GIGABEAT_PAD}{
      ...
      register a touchpad press. If set to \opt{SANSA_FUZEPLUS_PAD}{\setting{25}}\opt{GIGABEAT_PAD}{\setting{High}}
      the lightest touch will register. If set to \opt{SANSA_FUZEPLUS_PAD}{\setting{-25}}\opt{GIGABEAT_PAD}{\setting{Normal}}
      a firmer press will be needed to register on the touchpad.
    }
    \end{description}
}
