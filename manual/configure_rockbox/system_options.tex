...
\opt{SANSA_FUZEPLUS_PAD}{
  \subsection{Touchpad Sensitivity}
    This setting controls the amount of pressure needed to register a touchpad
    press. If set to 25 the lightest touch will register. If set to -25 a firm
    press will be needed to register on the touchpad.
}
