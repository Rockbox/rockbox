...
\item[Browse Theme Files.]
  ...
  \opt{archosplayer}{\url{http://themes.rockbox.org/index.php?target=player}}%
  \opt{archosrecorder}{\url{http://themes.rockbox.org/index.php?target=fmrecorder}}%
  \opt{archosrecorderv2fm}{\url{http://themes.rockbox.org/index.php?target=fmrecorder}}%
  \opt{archosondiofm}{\url{http://themes.rockbox.org/index.php?target=ondiofm}}%
  \opt{archosondiosp}{\url{http://themes.rockbox.org/index.php?target=ondiosp}}%
  ...
  \opt{ipodmini1g}{\url{http://themes.rockbox.org/index.php?target=ipodmini}}%
  \opt{ipodnano1g}{\url{http://themes.rockbox.org/index.php?target=ipodnano}}%
  \opt{sansae200}{\url{http://themes.rockbox.org/index.php?target=e200}}%
  \opt{sansac200}{\url{http://themes.rockbox.org/index.php?target=c200}}%
  \opt{gigabeatfx}{\url{http://themes.rockbox.org/index.php?target=gigabeatf}}%
