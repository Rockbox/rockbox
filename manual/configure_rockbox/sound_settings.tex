...
\section{Channels}
  ...
  \begin{description}
      ...
      \item[Swap.]
          Sends the left signals to the right channel and vice versa.
      \item[Delay L.]
          Enable an offset delay to the left channel. This setting helps to move
          the stereo image towards to the front of the driver in a car audio
         envirement where driver's seat is on the left side.
       \item[Delay R.]
          Enable an offset delay to the right channel. This setting helps to move
          the stereo image towards to the front of the driver in a car audio
         envirement where driver's seat is on the right side.
  \end{description}
...
\section{Sample Delay}
  Sample delay allows you to manually specify the effect that is appplied
  when the \setting{Channels} setting is set to ``Delay L'' or ``Delay R''.
  From 0 to 182 samples where a larger value will make stereo image
  less centering.
