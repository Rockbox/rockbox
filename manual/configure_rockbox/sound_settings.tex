...
\section{\label{ref:EQ}Equalizer}
  ...
  equalizers, a parametric EQ enables adjusting the type, center frequency, gain, and
  ...
  Rockbox's parametric EQ is composed of up to ten EQ bands consisting of any combination of three different filter types:

  \begin{description}
  \item[Low shelf filter.]
        Low shelf filters boost or lower all frequencies below a certain
  ...
  \item[Peaking filters.]
        ...
        different parameters. The ``centre'' parameter
  ...
  \item[High shelf filter.]
        ...
        stereo systems does.
        A high shelf filter is adjusted the same way as A low shelf filter,
  ...
  of the five EQ bands.
    ...
    \begin{btnmap}
      ...
      \opt{HAVEREMOTEKEYMAP}{
          ...
          &}
      Toggles the cursor among the four parameters (type, gain, centre
      frequency, Q) for the selected EQ band
          \\
      %
