...
\opt{swcodec}{
\section{Perceptual Bass Enchancement}
Perceptual bass enchancement boosts lower frequencies while applying a 
frequency-dependent phase delay that emphasizes bass.  Note that this effect
will stack on top of any EQ-effects.

\section{PBE Precut}
Digital attenuation applied to PBE prior to processing to reduce clipping.
