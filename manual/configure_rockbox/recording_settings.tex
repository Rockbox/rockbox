...
\opt{swcodec}{
  ...
  \section{Frequency}
   \nopt{sansa}{
    ...
    \opt{iriverh100,iriverh300}{44.1kHz, 22.05kHz and 11.025kHz}
    \opt{iaudiox5}{88.2kHz, 44.1kHz, 22.05kHz and 11.025kHz}
    ...
    \opt{archosrecorder,archosrecorderv2fm,iriverh100}
...
\section{Source}
  ...
  \opt{archosrecorder,archosrecorderv2fm,iriverh100}{\setting{SPDIF (digital)}, }%
  \nopt{ipodnano1g,ipodvideo}{\setting{Mic}}%
