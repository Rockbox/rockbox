...
The \setting{Playlists} sub menu allows you to configure settings
...
\item[Playlist Viewer Settings.]
   This sub menu contains settings related to the Playlist Viewer.
   \begin{description}
...
\item[Current Playlist.]
  This sub menu contains settings related to the current dynamic playlist.
  \begin{description}
  ...
  \item[Shuffled Adding.]
  If set to \setting{Hide}, Rockbox will not offer to add shuffled tracks
  in the Current Playlist submenu.

  \item[Queue Options.]
  If set to \setting{Hide}, Rockbox will not display the options to queue items in
  the \setting{Current Playlist submenu}.
  If set to \setting{Relocate to Submenu}, Rockbox will move the options into a
  separate submenu.
