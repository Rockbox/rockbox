...
\subsection{Pause First Loaded Track}
  If enabled and a track was not previously loaded since startup
  then playback is paused pending an explicit press of the play button.
  \end{description}
