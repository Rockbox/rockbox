...
\section{\label{ref:AutoChangeDirectory}Auto-Change Directory}
  ...
  \note{If you have set \setting{Start File Browser Here} to a directory
    other than root, \setting{Auto-Change Directory} will be constrained
    to the directory you have chosen and those below it.
