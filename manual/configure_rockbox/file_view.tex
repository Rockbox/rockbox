...
\item[\label{ref:ShowExtensions}Show Filename Extensions:]
  ...
  \item[Only when viewing all types:] Only show file extensions when \setting{Show Files} is set to \setting{All}.
  \end{description}
...
\item[Show Icons:]
  ...
  in the \setting{File Browser}. For details of these icons, please see
