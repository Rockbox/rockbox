...
;
    ...
    if($bitmap) {
        ...
        # Picross bitmaps
        copy("$ROOT/apps/plugins/bitmaps/native/picross_cursor.bmp",
             "$temp_dir/rocks/games/picross_cursor.bmp");
        copy("$ROOT/apps/plugins/bitmaps/native/picross_numbers.bmp",
             "$temp_dir/rocks/games/picross_numbers.bmp");
        if($depth < 16) {
            copy("$ROOT/apps/plugins/bitmaps/native/picross_squares.mono.bmp",
                 "$temp_dir/rocks/games/picross_squares.bmp");
        } else {
            copy("$ROOT/apps/plugins/bitmaps/native/picross_squares.bmp",
                 "$temp_dir/rocks/games/picross_squares.bmp");
        }
    }
